...
public class DesignDocument extends VerilogDocument  
    implements MappedModuleSpecifier
{

    private static final String _RCS_ = "RCS_REVISION: $Rev: 113 $";
    ...
    public DesignDocument (Design design)
    {
        ...
        //
        Comment header = new Comment("Open Forge " + Version.versionNumber(), Comment.SHORT);
        append(header);
        String runDate = EngineThread.getGenericJob().getOption(OptionRegistry.RUN_DATE).getValue(CodeLabel.UNSCOPED).toString();
        ...
        for(Iterator iter = design.getIncludeStatements().iterator(); iter.hasNext();)
        {
    ...
    /**
     * Appends a verilog module to the end of the document, and gathers any needed 
     * include directives.
     */
    public void append(Module module) 
    {
        ...
        {
            mappedModules.addAll(((MappedModuleSpecifier)module).getMappedModules());
        }
    } // append()
