...
/**
 * FifoID is a class that is simply used to completely encapsulate the
 * syntax and format of the encoded String names that are used by the
 * C Model to create 'stub' functions which are used as placeholders
 * until LIM construction for Fifo access nodes.  This class can
 * convert the relevent fifo characteristics into an encoded string
 * function name and vice-versa.
 *
 *
 * <p>Created: Mon Dec 15 12:48:56 2003
 *
...
public abstract class FifoID 
{
    ...
    /**
     * Generates a default state FifoID instance that can be populated
     * as needed.
     */
    public FifoID ()
    {}
    ...
    /**
     * Generates a fully 'populated' FifoID instance from a legally
     * encoded string name {@link #getEncodedID}, {@link #getReadID},
     * or {@link #getWriteID}.
     *
     * @param encoded a value of type 'String'
     * @throws IllegalArgumentException if the encoded string is not a
     * legally encoded string.
     */
    public FifoID (String encoded)
    {
        ...
        {
            throw new IllegalArgumentException("Unknown syntax for encoded fifo identifier");
        }
        ...
        for (int i=0; i < tokens.length; i++)
        {
            ...
            {
                throw new IllegalArgumentException("Illegal Syntax for Fifo Identification " + encoded + " Unknown key: " + token);
            }
        }
    }

    /**
     * Sets the specified value as the width (in bytes) of the Fifo
     * interface. 
     *
     * @param width a positive int value.
     * @throws IllegalArgumentException if width is 0 or negative.
     */
    ...
    /**
     * Sets the id number of this FifoID.  ID numbers are used to
     * uniquely identify one fifo interface from another in the
     * design.
     *
     * @param id any String
     */
    ...
    {
        if ((type != TYPE_FSL) && (type != TYPE_ACTION_SCALAR) && (type != TYPE_ACTION_OBJECT))
        {
            throw new IllegalArgumentException("Unknown interface type specified " + type);
        }
     ...
     *
     * @return an int, matching one of the public static final ints in
     * this class.
     */
    public int getType ()
    {
    ...
    /**
     * Return the unique name (prefix) for this identified interface,
     * eg FSLnum, etc.
     *
    ...
    /**
     * Sets the direction of the identified Fifo interface, true if
     * the Fifo interface is an input to the design, false otherwise.
     *
     * @param read a value of type 'boolean'
     */
    ...
    /**
     * Returns true if this identifier specifies an input (read) fifo
     * interface .
     *
     * @return a 'boolean'
     */
     ...
     * incorporates all the relevent characteristics set via the
     * 'setXXX' methods.  This string is parseable by the constructor
     * of this class which accepts a string.
     *
     * @return an encoded, non-empty, String
     */
    private String getEncodedID ()
    {
        // &dir=XXX&id=YYYY&width=ZZZZ&type=QQQQ
    ...
    /**
     * Returns a String which fully encodes all the properties of a
     * read access to the Fifo indicated by this FifoID
     *
     * @return a value of type 'String'
     * @throws UnsupportedOperationException if the direction of this
     * fifo is not input.
     */
    public String getReadID ()
    {
        if (!this.isInput)
        {
            throw new UnsupportedOperationException("Cannot read from an output fifo interface");
        }
    ...
    /**
     * Returns a String which fully encodes all the properties of a
     * write access to the Fifo indicated by this FifoID
     *
     * @return a value of type 'String'
     * @throws UnsupportedOperationException if the direction of this
     * fifo is not output.
    ...
    public String getWriteID ()
    {
        if (this.isInput)
        {
            throw new UnsupportedOperationException("Cannot write to an input fifo interface");
        }
