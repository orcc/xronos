...
public class ConditionalAndOpRule 
{
    ...
    public static boolean halfConstant(ConditionalAndOp op, Number[] consts, ComponentSwapVisitor visit)
    {
        ...
        if (constant.longValue() != 0)
        {
            ...
            {
                if (_optimize.db) _optimize.ln(_optimize.HALF_CONST, "\tReplacing " + op + " due to (a && 1)");
