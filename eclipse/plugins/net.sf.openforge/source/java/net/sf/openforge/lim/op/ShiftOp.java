...
/**
 * ShiftOp is the base class for all types of Shifts in the LIM and contains
 * functionality common to them all. A ShiftOp must know the maximum number of
 * stages necessary to implement the shift.
 * 
 * <p>
 * Created: Thu Oct 3 13:36:20 2002
 * 
...
public abstract class ShiftOp extends BinaryOp {
	...
	/**
	 * The maximum number of stages which should be needed to perform this shift
	 * operation. Which should be log2 of the natural size of this operation
	 */
	 ...
	 * 
	 * @param maxStages
	 *            the maximum number of stages necessary to build a functionally
	 *            correct shifter, equal to log base2 of the natural size of the
	 *            data type being shifted (rounded up).
	 */
	...
	/**
	 * Get the maximum number of stages which should be needed to perform this
	 * shift operation.
	 */
	...
	/**
	 * Gets the constant value applied to the shift magnitude input or -1 if not
	 * a constant value.
	 * 
	...
	/**
	 * Gets the actual number of stages needed to compute the shift, based upon
	 * the current {@link Value} of the right data {@link Port}.
	 * 
	 * @return the number equal to the number of non-constant care bits in the
	 *         right data port value
	 */
