...
public class MultiplyOp extends BinaryOp implements Emulatable
{
    ...
    /**
     * Returns the natural size of this operation, used by
     * optimizations to build shifts for implementation.
     */
    ...
    /**
     * Returns the defined number of pipeline stages for this
     * multiplier by the user via the
     * {@link ScheduleDefiner#SCHEDULE_MULTIPLY_STAGES} preference.
     *
     * @return a non-negative 'int'
     */
    public int getPipeStages ()
    {
        Option option = getGenericJob().getOption(OptionRegistry.SCHEDULE_MULTIPLY_STAGES);
    ...
    public boolean pushValuesForward()
    {
        ...
        {
            int compactedSize = Math.min(newSize, in0.getCompactedSize() + in1.getCompactedSize());
    ...
    /**
     * Reverse constant prop on a MultiplyOp simply propagates the
     * consumed value back to the Ports. Each port has the size not
     * wider than the consumed value, all bits are care.
     *
