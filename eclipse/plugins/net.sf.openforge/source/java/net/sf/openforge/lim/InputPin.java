...
public class InputPin extends Pin
{
    ...
    /**
     * Construct a new InputPin based on a Port
     * Note: the Port is expected to have a {@link Value} which
     * provides the sizing information.
     *
     * @param port the Port upon which to base the InputPin
     */
    ...
    /**
     * Constructs a new InputPin. The pin may have a different width
     * than the it's bus, though the signedness must match. 
     * Optimization may have downsized the data path leading from
     * the Pin, but the pin may have an explicit width requirement,
     * even if all the bits aren't used internally.
     * 
     * @param pinWidth
     * @param busWidth
     * @param isSigned
    ...
    /**
     * Augments the default behavior by also forcing the logical ID of the InputPin's
     * Bus to match. If you change this method make sure that you are somehow still
     * enforcing the names to be the same, or making it so that they no longer have
     * to be the same.
     *
