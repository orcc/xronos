 ...
 * a blending of the strict module_instance and module_instantiation
 * structures.
 * <P>
 *
 *
...
public class ModuleInstance implements Statement
{
    ...
    public ModuleInstance (Identifier name_of_module,
                           Identifier name_of_instance)
    {
    ...
    public ModuleInstance (String name_of_module,
                           String name_of_instance)
    {
    ...
    /**
     *
     * @param pc a port connection complete with Port to Net
     */
    public void add(PortConnection pc)
    {
        ...
        {
            throw new VerilogSyntaxException("Duplicate port connection: " + pc.toString());
        }
    } // add()
    
    /**
     *
     * @param pc a no connect with only a port
     */
     ...
     * .ARG0(iadd_4)
     *
     * @param port the name of the module port
     * @param e the expression to connect to the port
     */
