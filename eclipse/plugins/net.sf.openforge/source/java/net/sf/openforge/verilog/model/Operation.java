...
public abstract class Operation implements Expression
{
    ...
    /** Precedence constants are listed from lowest to highest. 
     In the source, different precedence levels are separated by a newline,
     while operations with the same precedence are bunched together.
     */
    ...
    public static class UnbalancedOperationException extends VerilogSyntaxException
    {
    ...
    /**
     * If sub classes override this method then we allow the input
     * sizes to not match.  This was added as a means of overcoming an
     * XST deficiency.  XST does not optimize multipliers with leading
     * 0s, so we trim those leading zeros as needed.  This can cause
     * the multiply to end up with unbalanced inputs.  
     *
     * @return false
     */
    ...
    public static final class ShiftLeft extends Operation
    {
        ...
        public int precedence() { return LEFT_SHIFT_PRECEDENCE; }
    ...
    public static final class ShiftRight extends Operation
    {
        ...
        public int precedence() { return RIGHT_SHIFT_PRECEDENCE; }
        public boolean isOrdered() { return true; }
