 ...
 * Use like this:
 * 
 * if (_timedc.db) { _timedc.ln("ugh"); }
 * 
 * if (_timedc.db) { _timedc.ln("glub"); }
 * 
 ************************************* 
 * 
 ...
 * _timedc.ln("Blug"); it is the default level.
 * 
 * For now, that is enough ;-)
 * 
 */
public class _timedc {

	// Add your tag here!
	public final static String TAG = "Timedc";
	...
	// Pipeliner
	public final static int PIPELINER = 0x1000;
	// Gate Depth Accumulator
	public final static int GDA = 0x800;
	// Global Resources Connection Visitor
	public final static int GVISIT = 0x400;
	// Structural Visitor
	public final static int SVISIT = 0x200;
	// Latency Tracker
	public final static int LT = 0x100;
	// Scheduling of the entries on each component.
	public final static int ENTRIES = 0x80;
	public final static int VISIT = 0x10;
	public final static int LOW = Debug.LOW;
	private final static Debug debug = new Debug(_timedc.class, TAG, db,
			VISIBLE);
	public final static Debug d = debug;// backwards compatability
