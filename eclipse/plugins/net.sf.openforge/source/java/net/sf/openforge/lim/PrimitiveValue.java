...
/**
 * PrimitiveValue represents the initial value of fields in a users
 * design which hold a primitive (byte, short, char, int, long, float,
 * double, boolean).
 *
...
public class PrimitiveValue implements InitialValue
{
    ...
    /** the location at which this PointerValue was created.  USED
     * ONLY FOR REPORTING. */
     ...
     *
     * @param value a value of type 'Number'
     */
    ...
    /**
     * Identifies where this primitive value was created in the users
    ...
    /**
     * Retrieves the name of the users class that is responsible for
     * the instantiation of this PointerValue.
     */
    ...
    /**
     * Retrieves the name of the users field (within the declaring
     * class) that is responsible for the instantiation of this
     * PointerValue.
     */
    ...
    /**
     * Returns a new PrimitiveValue with the same Number initial
     * value.
     */
