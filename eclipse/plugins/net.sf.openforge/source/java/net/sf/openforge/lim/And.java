...
/**
 * An And accepts multiple 1-bit signals, and'ing them together to generate a 1-bit result.
 * The go port and done bus of an And are unused.
 *
...
public class And extends Primitive
{
     ...
     *
     * @param goCount  The number of data inputs to be and'd
     */
