...
/**
 *
 * This class is used to describe a set of pin data. For example,
 * in a constructor if you want to set pin values at
 * clock ticks 7, 12 and 15, you can do that by doing:
 *
 * <code><pre>
 *
 ...
 * </pre></code>
 *
 * This has the effect of setting clock ticks 0-6 as X/Don'tCare,
 * 7 as 0x10, 8-11 as X/Don'tCare, 12 as 0x11, 13-14 as X/Don'tCare,
 * and 15 as 0x12.<p>
 *
 ...
 * contiguous data as well<p>
 *
 * Be advised that this data set is only as long as the last element specified<p>
 */
public class AbsolutePinData extends PinData
{

    private TreeMap pinDataMap=new TreeMap();
    ...
    /**
     * Construct a data set with one value at the specified
     * clock tick. Prior values will be SignalValue.X
     *
     * @param clockTick clock tick to set value at
    ...
    /**
     * Construct a data set using a SeqeuentialPinData stream
     * provided with its first value starting at the specified
     * clock tick. Prior values will be SignalValue.X
     *
     * @param clockTick clock tick to set value at
     * @param spd SequentialPinData to use
     */
    ...
    public int getCycleCount()
    {
        ...
        {
            return ((Integer)pinDataMap.lastKey()).intValue() + 1;
        }
    }
     ...
     *
     * @param clockTick clock tick whose value you need
     * @return value 
     */
    ...
    /**
     * Set a specific value at a specific clock tick. This
     * overrides an existing value. This may extend the size of
     * this data set; intervening clock ticks will be filled in
     * with SignalValue.X
     *
     * @param clockTick clock tick to set data to start at
    ...
    /**
     * Set a specific sequence of values starting at a specific
     * clock tick. This overrides an existing value. This may
     * extend the size of this data set; intervening clock ticks
     ...
     *
     * @param apd  absolute pin data to merge in
     */
    ...
    public Map getMapping() { return pinDataMap; }
