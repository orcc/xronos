...
/**
 * An {@link OutPinBuf} state change access; the pin can be set to either drive
 * its output or enter high impedence state. It can also be synchronous, in
 * which case it takes effect at the next clock edge, or immediate.
 * 
...
public class PinStateChange extends PinAccess {
	...
	/**
	 * Returns a copy of this PinStateChange by creating a new access off of the
	...
	public class Physical extends PhysicalImplementationModule {
		...
		public Physical() {
			...
			sideEnable
					.setIDLogical(ID.showLogical(PinStateChange.this) + "_WE");
