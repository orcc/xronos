...
public interface ForgeDebug
{
    ...
    public final static GlobalDebug cmodel=new GlobalDebug("CModel",_cmodel,DEFAULT_LEVELS);

    // clinker (new)
    public final static boolean _clinker=false;
    public final static GlobalDebug clinker=new GlobalDebug("CLinker",_clinker,DEFAULT_LEVELS);

    // gloablapp (new) (Global app, i.e. hllc.app)
    public final static boolean _gapp=false;
    public final static GlobalDebug gapp=new GlobalDebug("Global App",_gapp,DEFAULT_LEVELS);
}
