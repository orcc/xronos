...
/**
 *
 * This class is used to describe a contiguous set of pin data. For example,
 * if you want to set the next seven pin values as 1 through 7, you can do
 * that by doing:
 *
 * <code><pre>
 *
 ...
 * values. <p>
 *
 * This is a CONTIGUOUS representation of pin data; note that that AbsolutePinData
 * can also manipulate data via the set(tick,data) paradigm but does not assure
 * contiguous data as well.
 */
public class SequentialPinData extends PinData
{

    private ArrayList pinDataSequence=new ArrayList();
    ...
    /**
     * Create a sequential, contiguous data set
     * from an array of SignalValues
     *
    ...
    /**
     * Create a sequential, contiguous data set
     * from another PinData type. The pin data type is treated
     * as a contiguous data set.
     *
     * @param pd PinData reference to use
     */
    ...
    /**
     * Turns an Absolute data set into a Sequential one;
     * "blank spots" are filled in with SignalValue.X
     *
     * @param apd AbsolutePinData set to use
     */
     ...
     *
     * @param clockTick tick between 0 and getCycleCount() -1
     ...
     *
     * @param vals a value of type 'SignalValue[]'
     */
     ...
     *
     * @param vals a value of type 'long[]'
     */
     ...
     *
     * @param vals a value of type 'float[]'
     */
     ...
     *
     * @param vals a value of type 'double[]'
     */
     ...
     *
     * @param val a value of type 'SignalValue'
     */
     ...
     *
     * @param val a value of type 'long'
     */
     ...
     *
     * @param val a value of type 'float'
     */
     ...
     *
     * @param val a value of type 'double'
     */
     ...
     *
     * @param s a space delimited sequence of values such "x z 0x10 0b11"
     */
    ...
    /**
     * Sets an arbitrary value at a particular clock tick.
     * If the size of the data set needs to be extended, X's will be
     * used to fill in the intervening space.
     *
     * @param clockTick 0-N clock tick
     * @param sv value
     */
    ...
    /**
     * Set a sequence of values starting at the specified
     * clock tick
     *
     * @param clockTick clock tick
     * @param pd SequentialPinData list
     */
     ...
     *
     * @param apd a value of type 'AbsolutePinData'
     */
     ...
     * Merge an AbsolutePinData set into this data set. 
     *
     * @param clockTick a value of type 'int'
     * @param apd a value of type 'AbsolutePinData'
     */
    public void set(int clockTick,AbsolutePinData apd)
    {
        for(Iterator it=apd.getMapping().entrySet().iterator();it.hasNext();)
        {
