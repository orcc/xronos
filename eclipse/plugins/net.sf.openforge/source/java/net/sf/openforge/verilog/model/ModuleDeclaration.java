 ...
 * module using an identifier and some ports. Technically, the
 * ModuleDeclaration should include everything inside the module
 * and the closing <code>endmodule<code> keyword. But restricting
