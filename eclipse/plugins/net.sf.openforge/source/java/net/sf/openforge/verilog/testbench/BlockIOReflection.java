...
import net.sf.openforge.lim.io.DeclarationGenerator;
import net.sf.openforge.util.exec.Drain;
import net.sf.openforge.util.exec.ExecutionException;
import net.sf.openforge.util.exec.GCC;
			...
			if (allData) {
				for (int j = 0; j < blockWidth; j++) {
					if (streamFormat[streamOffsets[element]] == BlockElement.DATA) {
						...
						throw new net.sf.openforge.app.ForgeFatalException(
