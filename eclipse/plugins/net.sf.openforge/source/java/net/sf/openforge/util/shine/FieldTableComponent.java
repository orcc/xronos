...
class FieldTableComponent extends JScrollPane
{
    ...
    private void initColumnSizes(JTable table, MyTableModel model)
    {
        ...
        for (int i = 0; i < 4; i++)
        {
            ...
            if(i!=3)
            {
                ...
                columnWidth+=2; // not sure why this is.... but you really need it for mods
    ...
    class MyTableModel extends AbstractTableModel
    {
        ...
        public int getColumnCount() { return 4; } // modifier, name, type, value
        ...
        public Object getValueAt(int row, int col)
        {
            switch(col)
            {
                ...
                case 1:
                    // type
                    if(oi.isArray(row))
                        return Array.getLength(oi.getValue(row))+""+oi.getType(row);
        ...
        int getMyPreferredWidth(int col)
        {
            ...
            {
                Component comp = table.getCellRenderer(i,col).getTableCellRendererComponent(
