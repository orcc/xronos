...
public class ResourceUtilizationReporter extends FilteredVisitor
{
    ...
    public ResourceUtilizationReporter (Design design, FPGAResource designResource, Map procedureResourceUsageMap, OutputStream os)
    {
        super();
        
        this.writer = new PrintWriter(os, true);
        this.designID = new String(design.showIDLogical());
    ...
    public void visit (Design design)
    {
        ...
        writer.println("<H2>");
        writer.println(this.designID + " Design Resource Utilization Report");
        writer.println("</H2>");
        writer.println("</CENTER>");
        writer.println("<HR>");
        writer.println("<H2>");
        ...
        writer.println("</H2>");
        writer.println("<UL>");
        writer.println("<LI TYPE=\"square\"><B><A HREF=\"ResourceUtilizationReport.html#" + this.designID + "\">" + this.designID +"</A></B>");
        super.visit(design);
        writer.println("</UL>");
    }
    ...
    {
        writer.println("<UL>");
        writer.println("<LI TYPE=\"circle\"><B><A HREF=\"ResourceUtilizationReport.html#" + procedure.showIDLogical() + "\">" + procedure.showIDLogical() +"</A></B>");
    ...
    {
        writer.println("<A NAME=\"" + this.designID + "\"></A><B>" + this.designID + "</B> design resource usage: ");
        writer.println("<BR>");
    ...
    {
        for (Iterator procIter = procedureResourceUsageMap.keySet().iterator(); procIter.hasNext();)
        {
            Procedure proc = (Procedure)procIter.next();
            FPGAResource procResource = (FPGAResource)procedureResourceUsageMap.get(proc);
         
            writer.println("<A NAME=\"" + proc.showIDLogical() + "\"></A><B>" + proc.showIDLogical() + "</B> resource usage: ");
            writer.println("<BR>");
