...
/**
 * A SharedProcedure allows a {@link Procedure} definition to
 * be shared by multiple {@link SharedProcedureCall SharedProcedureCalls}.
 * All references to the same SharedProcedure access the same
 * hardware instantiated by that procedure.
 *
...
public class SharedProcedure extends Resource
{
    ...
    /**
     * Gets the pipeline latency for a particular reference
     * to this referent.
     */
    ...
    /**
     * Creates a copy of this shared procedure (including a copy of
     * the backing {@link Procedure}).
     *
