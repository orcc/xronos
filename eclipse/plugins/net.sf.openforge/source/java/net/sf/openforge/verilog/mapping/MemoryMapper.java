...
public class MemoryMapper
{
    ...
    public final static String SIMPRIM_INCLUDE_PATH =
    ...
    private static Map mapMemoryType = new HashMap();
    ...
    /**
     * Returns the appropriate {@link VerilogMemory} (memory writer)
     * for the specified memory.  This decision is based very closely
     * on the specific {@link MemoryImplementation}
     *
     * @param memory a {@link MemoryBank}
    ...
    public static VerilogMemory getMemoryType (MemoryBank memory)
    {
        ...
        if (allocated == null)
        {
            ...
            {
                throw new IllegalArgumentException("All memories must have either 1 or 2 ports. Found: " + portCount);
            }
            mapMemoryType.put(memory, allocated);
        }
        //System.out.println("Allocated memory writer: " + allocated + " for " + memory + " " + memory.getImplementation());
        return allocated;
    }
