...
public abstract class Referee extends Module {
	 ...
	 * 
	 * @param referent
	 *            the referent which this Referee will manage
	 */
	...
	/**
	 * Returns a copy of this Referee in which the referent has <b>not</b> been
	 * cloned, so that the cloned referee still points to the same referent.
	 * 
