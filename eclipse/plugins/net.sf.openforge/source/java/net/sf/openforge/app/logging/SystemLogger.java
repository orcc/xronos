...
/**
 * a wrapper for the ForgeLogger which can replace System.err and System.out in user code
 * user prints will be spooled up and sent in full lines to the ForgeLogger.
 *
...
public class SystemLogger extends PrintStream
{
    ...
    {
        super(out);
        throw new RuntimeException("SystemLogger must be instantiated with the SystemLogger(int warnLevel) constructor");
    }
     ...
     * @param level one of verbose|info|warn|error
     */
