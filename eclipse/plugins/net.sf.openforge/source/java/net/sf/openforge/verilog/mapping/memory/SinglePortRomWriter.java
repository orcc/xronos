...
//         System.out.println("************* result_width " + result_width + " result_depth " + result_depth);
        ...
        for (int w = 0; w < result_width; w++)
        {
            for (int d = 0; d < result_depth; d++)
            {
                ...
                // them all to it.
                new_element.setAddr(adr, getAddrWidth(), 0, getAddrWidth() == 1);
...
//             memoryModule.declare(we[d]);
        ...
        memoryModule.state(new Assign.Continuous(fake_din, new HexNumber(0, getDataWidth())));
        ...
        for (int d = 0; d < result_depth; d++)
        {
            //memoryModule.state(new Assign.Continuous(we[d], new HexNumber(0,1)));
