...
/**
 * HeapWrite is an {@link OffsetMemoryWrite} whose offset value is a constant
...
public class HeapWrite extends OffsetMemoryWrite {
	 ...
	 *            the number of locations to be read
	 ...
	 *            access.
	 */
	public HeapWrite(int addressableLocations, int maxAddressWidth, int offset,
	 ...
	 *            , the number of unoptimizedd bits in this access
	 */
	public HeapWrite(int addressableLocations, int maxAddressWidth, int offset,
	 ...
	 * 
	 * @param memoryWrite
	 *            the actual {@link MemoryWrite} used to write the memory,
	 ...
	 *            location to be read
	 */
	private HeapWrite(MemoryWrite memoryWrite, int addressableLocations,
	...
	/**
	 * Clones this object. A new HeapWrite is created using a copy of the
