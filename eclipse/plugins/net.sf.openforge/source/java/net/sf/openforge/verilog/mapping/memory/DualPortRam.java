...
{
    private static final String rcs_id = "RCS_REVISION: $Rev: 490 $";
    ...
    private static DualPortRam[] v4block = {
        new RAMB16_S1_S1(),new RAMB16_S2_S2(),
        new RAMB16_S4_S4(),new RAMB16_S9_S9(),
        new RAMB16_S18_S18(),new RAMB16_S36_S36()};

    // virtex2/pro dual port lut based ram primitives
    private static DualPortRam[] v2lut = {new RAM16X1D(),new RAM32X1D(),new RAM64X1D()};

    // virtex2/pro dual port block ram based primitives
    private static DualPortRam[] v2block =
    {
        new RAMB16_S1_S1(),new RAMB16_S2_S2(),
        new RAMB16_S4_S4(),new RAMB16_S9_S9(),
        new RAMB16_S18_S18(),new RAMB16_S36_S36()};
    ...
    private static DualPortRam[] vblock = {
        new RAMB4_S1_S1(),new RAMB4_S2_S2(),
        new RAMB4_S4_S4(),new RAMB4_S8_S8(),new RAMB4_S16_S16()};
    
    protected DualPortRam()
    {
    }
    
    public static DualPortRam[] getDualPortMappers(XilinxDevice xd, boolean lut_map)
    {
        switch(xd.getFamily())
        {
    ...
    public void setAddr(String name, int width, int start, boolean scalar, int which)
    {
