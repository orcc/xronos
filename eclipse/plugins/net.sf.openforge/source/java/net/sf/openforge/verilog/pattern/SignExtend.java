...
/**
 * SignExtend is a design pattern which implements sign extension of a Net.
 * It will either present the sign extend as a concatenation of the replicated
 * top bit with the remainder of the net, or as a ranged net.
 * <P>
...
public class SignExtend implements Expression
{
    ...
    public SignExtend (Net base, int width)
    {
        ...
        if (width > base_width)
        {
            ...
            Replication r = new Replication(extra_bits, base.getRange(base_width - 1, base_width - 1));

            Concatenation c = new Concatenation(new Expression[] { r, base.getFullRange()});
    ...
    /** 
     * Overloaded constructor with a dummy boolean parameter 
     * just serves the purpose for creating a unsigned extend
     *
     * @param base
     * @param width
     * @param dummy
