...
package net.sf.openforge.forge.api.runtime;


import java.io.File;

/**
 * The <code>RunTime</code> class is supplied to give the user's
 * program access to Forge compilation settings.  The class is very
 * helpful when creating generic IPCore abstraction classes that self
 * configure based on the runtime settings of Forge such as the target
 * device family.  This class is structured such that the methods can
 * be called from within Forgeable code.  <div>NOTE: some values will
 * change based on the compilation step in Forge.  If your code relies
 * on contex sensitive information, such as the source directory then
 * the value should be stored locally for later use.  An example of
 * this would be an <code>HDLWriter</code> used for an
 * <code>IPCore</code> that is contained in an operation replacement
 * library and the writer needs the source directory associated with
 * the replacement class, not the design that is being compiled, then
 * the writer must keep a copy of the source directory during
 * construction of its class since during translation the source
 * directory will be set to the design that is being compiled.
 * <div>NOTE: Any
 * <code>File</code> returned by a method of this class might not
 * exist in the file system depending on the compilation step Forge is
 * in.
 */
public class RunTime
{
    ...
    /**
     * The <code>int</code> value representing the <code>VIRTEX</code>
     * family returned by <code>getFamily</code>.
     *
     */
    public static final int    VIRTEX = 0x00000001;

    /**
     * The <code>int</code> value representing the <code>VIRTEX2P</code>
     * family returned by <code>getFamily</code>.
     *
     */
    ...
    /**
     * The <code>int</code> value representing the <code>VIRTEX2</code>
     * family returned by <code>getFamily</code>.
     *
     */
    ...
    /**
     * The <code>int</code> value representing the <code>VIRTEXE</code>
     * family returned by <code>getFamily</code>.
     *
     */
    ...
    /**
     * The <code>int</code> value representing the <code>SPARTAN</code>
     * family returned by <code>getFamily</code>.
     *
     */
    ...
    /**
     * The <code>int</code> value representing the <code>SPARTAN2</code>
     * family returned by <code>getFamily</code>.
     *
     */
    ...
    /**
     * The <code>int</code> value representing the <code>SPARTAN2E</code>
     * family returned by <code>getFamily</code>.
     *
     */
    ...
    /**
     * The <code>int</code> value representing the <code>SPARTANXL</code>
     * family returned by <code>getFamily</code>.
     *
     */
    ...
    /**
     * The <code>int</code> value representing the <code>SPARTAN3</code>
     * family returned by <code>getFamily</code>.
     *
     */
    ...
    /**
     * Retrives the target FPGA family as an <code>int</code>.  The
     * family value can be compared against the constant fields of
     * this class such as <code>VIRTEX2</code>.
     *
    ...
    /**
     * Retrieves the directory that contained the source file Forge is
