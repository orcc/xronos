...
/**
 * XLIMConstants contains the definitions of the recognized
 * XLIM tags/attributes.
 *
 *
 * <p>Created: Fri Jun 10 14:20:54 2005
 *
...
public class SLIMConstants 
{
    ...
    //
    public static final String CONFIG_OPTION = "config_option"; // Tag name for configurable options
    public static final String CONFIG_NAME = NAME;
    public static final String CONFIG_VALUE = "value";
    public static final String CONFIG_MAXGATEDEPTH = "maxgatedepth"; // takes a positive value.  0 indicates no pipelining
    public static final String CONFIG_LOOPUNROLL = "loopunroll"; // takes a value from -1 to max int indicating max # of iterations if the loop is to be considered unrollable
    public static final String CONFIG_MINSRLLENGTH = "minsrllength"; // takes a value from 2 to max int indicating minimum # of registers to be merged into an SRL

    public static final String REMOVABLE = "removable"; // legal values are yes or no
    public static final String AUTOSTART = "autostart"; // legal values are true or false
    ...
    public static final String BITNOT = "bitnot"; // These two are the same thing...
