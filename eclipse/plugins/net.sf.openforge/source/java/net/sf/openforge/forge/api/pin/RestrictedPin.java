...
/**
 * A <code>RestrictedPin</code> provides restricted access to another
 * Buffer. It does not support any read or write operations, but does
 * allow the manipulation of pin attributes (UCF, size, name, etc.).
 */
public class RestrictedPin
{
    /** The original pin to which this RestrictedPin provides
        restriced access. */
    Buffer original;
    ...
    /**
     * Adds the specified {@link UCFAttribute} to this RestrictedPin.
    ...
    /**
     * Returns the bit width of this <code>RestrictedPin</code>.
     * (Defers to the original pin)
     *
    ...
    /**
     * Returns whether this RestrictedPin uses signed values.
     * (Defers to the original pin)
     * 
    ...
    /**
     * Sets whether this RestrictedPin uses signed values.
     * (Defers to the original pin)
     * 
    ...
    /**
     * Returns the name of this <code>RestrictedPin</code>.
     * (Defers to the original pin)
     *
     * @return a <code>String</code> value
     */
    ...
    /**
     * Sets the name of this <code>RestrictedPin</code>.
     * (Defers to the original pin)
     *
    ...
    /**
     * Sets the bit width of this <code>RestrictedPin</code>
     * (Defers to the original pin)
     *
    ...
    /**
     * Identifies the reset behavior of this RestrictedPin.  The RestrictedPin will
     * behave in one of two ways depending on how it is constructed.
     * <ul>
     * <li>If this method returns true, the RestrictedPin will come out of
     ...
     * until this RestrictedPin is tri-stated via a call to a
     * <code>release</code> method on this RestrictedPin.
     ...
     * call to a <code>drive</code> method on this RestrictedPin.
     * </ul>
     * (Defers to the original pin)
     *
    ...
    /**
     * Returns if this <code>RestrictedPin</code> had a reset value supplied
     ...
     * into the bit width of this <code>RestrictedPin</code>.
     * <P>
