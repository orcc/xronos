...
public class ComplementOp extends UnaryOp implements Emulatable {
	 ...
	 * ComplementOp according to these rules:
	 * 
	 * <pre>
	 * ~x = x
	 * ~c = c
	...
	/**
	 * Reverse constant prop on a ComplementOp simply propagates the consumed
	 * value back to the Port. Any constant/dc bits in the output produce don't
	 * care bits on the input.
	 * 
	 * @return a value of type 'boolean'
	 */
	@Override
