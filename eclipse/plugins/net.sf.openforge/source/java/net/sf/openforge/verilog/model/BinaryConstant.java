...
public class BinaryConstant extends Constant
{
    ...
    /**
     * Removes whitespace and underscore characters from
     * a String. 
     */
    ...
    /**
     * Parses a String as a binary value, returning the value
     * as a long.
     *
     * @param binary the string to parse
     * @return the parsed value, or just 0 (zero) if the bits are mixed (Z or X with 0 and 1)
     */
    public static long parseBinary(String binary)
    {
        long result =0;
        if (!verify(binary)) throw new NumberFormatException(binary);
    ...
    /**
     * Verifies that a given string can be used as a valid binary representation.
     *
     */
