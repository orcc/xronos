...
public class CodeLabel implements SearchLabel
{
     ...
     *
     * @param enclosing the Procedure within which the labeled block appears
     ...
     * sequence of label strings, substituting the provided label
    ...
    public String toString()
    {
        ...
        return new String(
            net.sf.openforge.util.naming.ID.showDebug(enclosingProcedure) +
            " with label " + label);
        else
    ...
    /**
     * A List which produces a sequence of increasingly general labels.
     * The iterator build search strings based on the enclosing procedure and
     * the label (any component of which may not be present).
     * <P>
    ...
    private void addVariations(String label, List searchList)
    {
            if (enclosingProcedure != null)
            {
                ...
                if ((packageName != null) && (packageName.equals(""))) packageName = null;
                if ((className != null) && (className.equals(""))) className = null;
                if ((methodName != null) && (methodName.equals(""))) methodName = null;
                if ((signature != null) && (signature.equals(""))) signature = null;
