...
/**
 * PrettyPrinter applies formatting rules to a stream of Verilog tokens
 * to produce pretty-printed verilog output.
 *
 * @author    <a href="mailto:andreas.kollegger@xilinx.com">Andreas Kollegger</a>
 * <p>created   July 31, 2002
...
public class PrettyPrinter
{
     ...
     *
     * @param os  the OutputStream to which output should be sent
     */
     ...
     * Constructs a new PrettyPrinter.
     *
     * @param w  the Writer to which output should be sent
     */
     ...
     * 
     * @param doc the VerilogDocument to be printed
     */
     ...
     *
     * @param element  the VerilogElement to be printed
     */
    ...
    /**
     * A "wire" keyword was just processed, so expect a series
     * of tokens representing a wire declaration. Two possible forms...
     * <P>
     * <CODE>
     * wire [31:0] arg0;<BR>
     * wire        arg1;
    ...
    {
        if (!Control.isWhitespace(previous) && 
            !Symbol.isDelimiter(previous) &&
