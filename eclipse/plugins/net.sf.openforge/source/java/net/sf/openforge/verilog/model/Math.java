...
/**
 * Math provides a collection of nested classes to represent mathematical operations.
 *
 * <P>
 *
...
public abstract class Math extends Operation
{
    ...
    public static final class Add extends Math
    {
        ...
        public int precedence() { return BINARY_PLUS_PRECEDENCE; }
    ...
    public static final class Subtract extends Math
    {
        ...
        public int precedence() { return BINARY_MINUS_PRECEDENCE; }
    ...
    public static final class Multiply extends Math
    {
        ...
        public int precedence() { return MULTIPLY_PRECEDENCE; }
        public boolean isOrdered() { return false; }
        public boolean allowUnbalanced() {return true;}
    ...
    public static final class Divide extends Math
    {
        ...
        public int precedence() { return DIVIDE_PRECEDENCE; }
        public boolean isOrdered() { return true; }
    ...
    public static final class Modulus extends Math
    {
        ...
        public int precedence() { return MODULUS_PRECEDENCE; }
        public boolean isOrdered() { return true; }
