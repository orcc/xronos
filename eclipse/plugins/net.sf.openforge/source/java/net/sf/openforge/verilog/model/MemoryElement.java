...
public class MemoryElement extends Net
{
     ...
     *
     * @param memory the Register identifier of the memory
     * @param address an expression which selects a word in the memory
     */
    ...
    /**
     * Constructs a new MemoryElement which uses an integer
     * constant to select the address.
     * 
     * @param memory the Register identifier of the memory
     * @param address the integer which selects a word in the memory
     */
     ...
     * MemoryElement (identifier plus a range). If MSB==LSB, then the
    ...
    public class MemoryElementRange implements NetLValue
    {
        ...
        public MemoryElementRange(int msb, int lsb) 
        {
            ...
            if (msb == MemoryElement.this.getMSB() && lsb == MemoryElement.this.getLSB())
                range = null;
            else
