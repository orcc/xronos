...
/**
 * An Access is a {@link Reference} to a {@link Resource}. It represents a call
 * by reference; the HDL that is generated must include explicit connections
 * between the Access and its Resource.
 * 
...
public abstract class Access extends Reference implements Referencer {
	...
	/**
	 * Gets the {@link Resource} that is targetted by this Access, may be null.
	 */
	...
	/**
	 * Returns the targetted resource as a {@link Referenceable} object.
	 * 
	...
	/**
	 * Removes this Access from the targetted Resource, or does nothing if the
	...
	/**
	 * Returns the latency reported by the {@link Referent} of this Reference.
	 * 
