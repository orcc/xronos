...
public class Keyword extends Token
{
    ...
    private static final String _RCS_ = new String("RCS_REVISION: $Rev: 2 $");
    ...
    public static Keyword PULSESTYLE_ONEVENT = new Keyword_2001("pulsestyle_onevent");
    public static Keyword PULSESTYLE_ONDETECT = new Keyword_2001("pulsestyle_ondetect");
    ...
    public static Keyword NOUNCONNECTED_DRIVE = new Keyword("`nounconnected_drive");
    ...
    /** 
     * Tests the given String to see if it is a valid
     * verilog Net type (wire, reg, input, etc).
     */
    ...
    /** 
     * Tests the given Token to see if it is a valid
     * verilog Net type (wire, reg, input, etc).
     */
    ...
    /**
     * Tests the given Token to see if it is a standard
    ...
    /**
     * Tests the given String to see if it is a standard
     * verilog compiler directive.
     */
    ...
    /**
     * Tests the given String to see if it is a recognized
     * time unit designation which may be used with the
     * timescale directive.
     */
    ...
    /**
     * Tests the given Token to see if it is a recognized
     * time unit designation which may be used with the
     * timescale directive.
     */
