...
public class NewDebug
{
     ...
     */
    public NewDebug(Class controlClass,String tag,OutputStream os,String levels,boolean compiledIn)
    {
...
class TestClass
{
    ...
    public final static NewDebug d=new NewDebug(TestClass.class,"Debug Tag",System.out,"! test1",dbg);

    public TestClass(String[] args)
    {
        for(int i=0;i<args.length;i++)
        {
            if(dbg) { d.ln("test1 test2","testing1: "+args[i]); }
            if(dbg) { d.ln("test2","testing2: "+args[i]); }
        }
    }
}
