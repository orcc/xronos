...
/**
 * A Verilog Wire which is based on a LIM {@link Bus}.<P>
 *
 * Created:   May 7, 2002
 *
...
public class BusWire extends Wire implements BusNet
{
     ...
     * @param name  String name for this BusWire
     */
    public BusWire (Bus bus, String name)
    {
        /*
         * Get the size from the given Bus (not its source), since this
         * is the correct size as set by constant propagation.
         */
    ...
    /**
     * Constructs a BusWire based on a LIM Bus. Bus.getSource(0 is used
     * to retrieve the upstream Bus which actually produces a signal.
     *
     * @param bus  The LIM Bus upon which to base the Net
     */
