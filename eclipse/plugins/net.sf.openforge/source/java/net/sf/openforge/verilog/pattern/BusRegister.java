...
/**
 * A Verilog Register which is based on a LIM {@link Bus}.<P>
 *
 * Created:   May 7, 2002
 *
...
public class BusRegister extends Register implements BusNet
{
     ...
     * @param initialValue The initial value of the bus
     */
    public BusRegister(Bus bus, Value initialValue)
    {
        super(ID.toVerilogIdentifier(ID.showLogical(bus)), bus.getValue().getCompactedSize());
        this.bus = bus;
    ...
    /**
     * Returns an Expression (the constant value) of the initial value
     * of this BusRegister, used in the declaration.
     *
     * @return a value of type 'Expression'
     * @throws NonConstantInitialValueException if the initial value
     * is not a constant
     */
    public Expression getDeclarationInitial () throws NonConstantInitialValueException
    {
        ...
        {
            long initNum = this.initialValue.toNumber().numberValue().longValue();
