...
/**
 * RangeReversed provides a bit select in the 'inverted' form, where
 * the lsb is listed first, as in [7] or [0:31].  The only difference
 * in this class from {@link Range} is in the lexicalify method which
 * reversed the ordering of the lsb/msb values.
 *
 *
 * <p>Created: Fri Aug  6 12:29:40 2004
 *
