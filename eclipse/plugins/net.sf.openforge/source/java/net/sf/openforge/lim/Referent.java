...
/**
 * A Referent is an entity that defines the behavior of one
 * or more standin operations called {@link Reference References}.
 * This allows the Referent to be defined once but used in
 * different contexts.
 * Each Reference is created by its Referent, which allows
 * the Referent to keep a record of all its
...
public abstract class Referent extends ID implements Cloneable
{
    ...
    private Set references = new HashSet(11);


    /**
     * Constructs a Referent.
     *
     * @param body the contents of the referent
     */
    public Referent ()
    {
        super();
    ...
    /**
     * Gets all references that were created from this referent,
     ...
     *
     * @param reference a reference that was created from this referent
     */
    public void removeReference (Reference reference)
    {
        if (!references.remove(reference))
        {
            throw new IllegalArgumentException("Removing Unknown reference: " + reference);
        }
    }
     ...
     *
     * @param reference a reference to be added to the list of
     *          known references
     */
    ...
    /**
     * Clones this referent and clears out the set of references
    ...
    public Object clone () throws CloneNotSupportedException
    {
        ...
        clone.references = new HashSet(11);
        return clone;
    }
