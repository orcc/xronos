...
/**
 * NewJob is the main interface and it maintains a single map with all the
 * preferences and options in it.
 * 
...
public interface NewJob {
	...
	/**
	 * This method is used to the set the values of the Options of Forge, from
	...
	/**
	 * This method is used to get an option based on the key passed to it.
	 * 
	 */
	public Option getOption(OptionKey key);

	/**
	 * Convenience method for determining the value of various command line
	 * switches.
	 */
	...
	@SuppressWarnings("serial")
	public static class InvalidOptionValueException extends
			ForgeOptionException {
	...
	@SuppressWarnings("serial")
	public static class InvalidNumberOfArgsException extends
			ForgeOptionException {
		public InvalidNumberOfArgsException() {
			super(
					"Invalid number of arguments to forge. Type \"forge -h\" for help.");
		}
	...
	public static class InvalidEntryValueException extends Exception {
		public InvalidEntryValueException(String key, String value) {
			super("Option named \"" + key + "\" can't be set to \"" + value
					+ "\", " + "function \"" + value
					+ "\" is not present in the provided source files");
		}
	} // inner class InvalidOptionValueException
