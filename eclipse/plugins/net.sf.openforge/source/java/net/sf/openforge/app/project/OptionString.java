...
public class OptionString extends Option
{
     ...
     */
    public OptionString(OptionKey key,
    ...
    public String validatePever(String s)
    {
        ...
        if (s.length() == 7)
        {
            ...
            if ((s.charAt(0) == 'v') && Character.isDigit(s.charAt(1)) && (s.charAt(2) == '_') &&
                Character.isDigit(s.charAt(3)) && Character.isDigit(s.charAt(4)) && 
                (s.charAt(5) == '_') && Character.isLowerCase(s.charAt(6)))
            {
                newVersionString = s;
            }
        }
        else if (s.length() == 6)
        {
            ...
            if (Character.isDigit(s.charAt(0)) && (s.charAt(1) == '_') &&
                ...
                (s.charAt(4) == '_') && Character.isLowerCase(s.charAt(5)))
            {
    ...
    /**
     * This method checks to see if the value passed to the option is 
     * of the right type. If true, it replaces the option value with 
     * that new value. Otherwise, it throws and InvalidOptionValue Exception.
     * @param slabel SearchLabel that can be used to get the scope.
     * @param val value to the option.
     */
    ...
    /**
     * Convenience method to pass on setValue method to super,
     * so that this class should not validate it.
     */
    ...
    /**
     * Convenience method to pass on replaceValue method to super,
     * so that this class should not validate it.
     */
