...
public class GnuOptionDefinition {
	...
	/**
	 * The flag for the status of the option's argument. Either NO_ARGUMENT,
	 * OPTIONAL_ARGUMENT, or REQUIRED_ARGUMENT
	 */
	...
	public GnuOptionDefinition(char shortKey, String longKey, int argFlag,
			String description) {
		this.shortKey = shortKey;
		this.longKey = longKey;
		if ((argFlag < NO_ARGUMENT) || (argFlag > REQUIRED_ARGUMENT)) {
			throw new IllegalArgumentException("Illegal value of argFlag -- "
					+ argFlag);
		}
	...
	/**
	 * The flag indicates the expected presence of the option's argument to be
	 * either NO_ARGUMENT, OPTIONAL_ARGUMENT, or REQUIRED_ARGUMENT.
	 * 
