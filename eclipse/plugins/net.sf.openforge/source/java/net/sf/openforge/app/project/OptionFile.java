...
public class OptionFile extends OptionRegExp {
	 ...
	 */
	public OptionFile(OptionKey key, String default_value, String regexp,
			boolean hidden) {
		super(key, default_value, regexp, hidden);
		if (regexp.equals(DIRECTORY_REGEXP))
			is_directory = true;
	} // OptionFile()
	...
	/**
	 * Checks if thie OptionFile is meant to select a directory rather than a
	 * File.
	 */
	 ...
	 * 
	 * @param clabel
	 *            Codelabel that can be used to get the scope.
	 * @param cwd
	 *            current working directory as obtained from CWD option
	...
	/**
	 * Checks to see if the value is valid! param s String value that is used to
	 * check for validity.
	 * 
