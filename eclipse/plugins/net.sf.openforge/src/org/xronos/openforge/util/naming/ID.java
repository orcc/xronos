...
import org.xronos.openforge.util.HF;


/**
 * ID clasfile. Top level class for the backend of naming. This class is
 * extended by things that need consistent naming...
 * 
 * @author C. Schanck
...
public class ID implements HasIDSourceInfo {
	...
	/**
	 * 
	 * This is experimentally turned on as of 8/20/2002. It is cleverer in that
	 * it attempts to keep a rolling id tab per type. So the first created Bus
	 * is bus0, the second is bus1, etc..
	 */
	...
	/**
	 * Copies all information except the global identifier from a source ID to a
	 * target ID. Useful when cloning IDs.
	 */
	public static void copy(ID source, ID target) {
		...
		try {
			target.isSourceInfo = (source.isSourceInfo == null ? null
	...
	public ID() {
		...
		if (_naming.db) {
			_naming.ln("Allocated (1) object idType: " + ID.showGlobal(this));
		}
	}
	...
	public void setSourceName(String s) {
		if (this.sourceName != null && s != null)
			throw new IllegalStateException(
					"Cannot override the source name attribute of an ID old:"
							+ this.sourceName + " new: " + s + " on " + this);
		this.sourceName = s;
	}
	...
	/**
	 * Get the IDSourceInfo block for this object. WIll not return null; uses
	 * lazy allocation.
	 * 
	...
	/**
	 * Use this to get the logical id for this object. If there is not a logical
	 * id, it returns the global id.
	 * 
	 * @return a value of type 'String'
	 */
	...
	/**
	 * Generates a string representation of where this ID comes from, of the
	 * form: <code><i>Name</i> at line <i>-1</i> in file <i>filename</i></code>
	 * 
	 * @return a value of type 'String'
	 */
	...
	/**
	 * Checks if this ID has been explicitly given a logical name using
	 * setIDLogical().
	 * 
	...
	public static String showGlobal(Object o) {
		...
		try {
			...
			return getDefaultIDType(o.getClass()) + "["
					+ HF.hex(System.identityHashCode(o)) + "]";
		}
	}
	 ...
	 * @return a value of type 'String'
	 */
	public static String glob(Object o) {
		return showGlobal(o);
	}

	public static String global(Object o) {
		return showGlobal(o);
	}

	/**
	 * Use this to get the idLogical id for any object. If there is not set
	 * idLogical id, it returns the global id. Handles nulls
	 * 
	 * @param o
	 *            a value of type 'Object'
	 * @return a value of type 'String'
	...
	public static String log(Object o) {
		return showLogical(o);
	}

	/**
	 * Dump the debug info for any object to the specified PrintStream. Handles
	 * nulls.
	 * 
	 * @param o
	 *            a value of type 'Object'
