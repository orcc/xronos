 ...
 * Use like this:
 * 
 * if (_shine.db) { _shine.ln("ugh"); }
 * 
 * if (_shine.db) { _shine.ln("glub"); }
 * 
 * ************************************
 * 
 ...
 * _shine.ln("Blug"); it is the default level.
 * 
...
public class _shine {
	...
	// Add your tag here!
	public final static String TAG = "Shine";
	...
	private final static Debug debug = new Debug(
			org.xronos.openforge.util.shine._shine.class, TAG, db, VISIBLE);
