...
/**
 * A Verilog Input which is based on a LIM {@link InputPin}.
 * <P>
 * 
 * Created: May 7, 2002
 * 
...
public class InputPinPort extends Input {
	...
	/**
	 * Gets the minimum width needed to represent an input pin. For an inferred
