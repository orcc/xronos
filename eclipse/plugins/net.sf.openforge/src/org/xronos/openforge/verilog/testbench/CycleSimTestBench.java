...
import org.xronos.openforge.forge.api.sim.pin.SignalValue;
...
import org.xronos.openforge.verilog.model.BinaryConstant;
...
import org.xronos.openforge.verilog.model.Directive;
...
import org.xronos.openforge.verilog.model.Inout;
...
import org.xronos.openforge.verilog.model.PortConnection;
...
import org.xronos.openforge.verilog.pattern.CommaDelimitedStatement;
import org.xronos.openforge.verilog.pattern.IncludeStatement;
import org.xronos.openforge.verilog.pattern.StatementBlock;
import org.xronos.openforge.verilog.translate.PrettyPrinter;
...
public class CycleSimTestBench {
		...
		for (Object o : clkPinToLogic.keySet()) {
			...
			if (clock.getApiPin().equals(cycleCountClockPin)) {
				block.add(new Assign.NonBlocking(index,
						new org.xronos.openforge.verilog.model.Math.Add(index,
			...
			block.add(new Assign.NonBlocking(tmpindex,
					new org.xronos.openforge.verilog.model.Math.Add(tmpindex,
	...
	private Statement getIndexTerminalStatement(ResultFile file, Net index,
		...
		cds.append(new org.xronos.openforge.verilog.model.Math.Add(index,
				new Constant(1, index.getWidth())));
