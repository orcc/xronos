 ...
 * Use like this:
 * 
 * if (_mapping.db) { _mapping.ln("ugh"); }
 * 
 * if (_mapping.db) { _mapping.ln("glub"); }
 * 
 ************************************* 
 * 
 ...
 * _mapping.ln("Blug"); it is the default level.
 * 
...
public class _mapping {
	...
	// Add your tag here!
	public final static String TAG = "Verilog Mapping";
	...
	private final static Debug debug = new Debug(
			org.xronos.openforge.verilog.mapping._mapping.class, TAG, db, VISIBLE);
