...
public abstract class PrimitiveAssignment extends ExpressionAssignment {
	...
	public static final class And extends PrimitiveAssignment {
		public And(org.xronos.openforge.lim.primitive.And and) {
			super(and);
		}
		...
		protected Expression makeExpression(List<Expression> operands) {
			...
			for (int i = 1; i < operands.size(); i++) {
				e = new org.xronos.openforge.verilog.model.Bitwise.And(e,
						operands.get(i));
			}
			return e;
		}
	...
	public static final class Or extends PrimitiveAssignment {
		public Or(org.xronos.openforge.lim.primitive.Or or) {
			super(or);
		}
		...
		protected Expression makeExpression(List<Expression> operands) {
			Expression e = operands.get(0);
			for (int i = 1; i < operands.size(); i++) {
				e = new org.xronos.openforge.verilog.model.Bitwise.Or(e,
						operands.get(i));
			}
			return e;
		}
	...
	public static final class Not extends PrimitiveAssignment {
		public Not(org.xronos.openforge.lim.primitive.Not not) {
			super(not);
		}
		...
		protected Expression makeExpression(List<Expression> operands) {
			...
			Expression e = operands.get(0);
			return (new org.xronos.openforge.verilog.model.Unary.Negate(e));
		}
	} // class Not
