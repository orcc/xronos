...
import org.xronos.openforge.verilog.model.SignedWire;
...
public abstract class MathAssignment extends BinaryOpAssignment {
	...
	public static final class Add extends MathAssignment {
		...
		protected Expression makeOpExpression(Expression left, Expression right) {
			return (new org.xronos.openforge.verilog.model.Math.Add(left, right));
		}
	} // class Add
	...
	public static final class AddMulti extends MultiPortOpAssignment {
		...
		protected Expression makeOpExpression(List<Expression> expressions) {
			...
			Expression result = new org.xronos.openforge.verilog.model.Math.Add(
					exprs.remove(0), exprs.remove(0));

			while (exprs.size() > 0) {
				result = new org.xronos.openforge.verilog.model.Math.Add(result,
						exprs.remove(0));
			}
	...
	public static final class Divide extends MathAssignment {
		...
		@Override
		protected Expression makeOpExpression(Expression left, Expression right) {
			return (new org.xronos.openforge.verilog.model.Math.Divide(left, right));
		}
	} // class Divide
	...
	public static final class Modulo extends MathAssignment {
		...
		@Override
		protected Expression makeOpExpression(Expression left, Expression right) {
			return (new org.xronos.openforge.verilog.model.Math.Modulus(left, right));
		}
	} // class Modulo
	...
	public static final class Multiply extends MathAssignment {
		...
		protected Expression makeOpExpression(Expression left, Expression right) {
			...
			// does not support
			return (new org.xronos.openforge.verilog.model.Math.Multiply(left,
					right));
		}
	...
	public static final class Subtract extends MathAssignment {
		...
		@Override
		protected Expression makeOpExpression(Expression left, Expression right) {
			return (new org.xronos.openforge.verilog.model.Math.Subtract(left,
					right));
		}
	} // class Subtract
