...
/**
 * 
 * This class is used to describe a repeating, contiguous set of pin data. For
 * example, if you want to set the next seven pin values to 0x10, you can do
 * that by doing:
 * 
 * <code><pre>
 * 
...
public class RepeatingPinData extends SequentialPinData {
	/**
	 * Create a repeating pin value based on a specified SignalValue which is
	 * certain number of clocks long
	 * 
	 * @param clockTicks
	 *            number of clocks to repeat value
	 * @param value
	 *            value to repeat
	 */
	...
	/**
	 * Create a repeating pin value based on a specified long which is certain
	 * number of clocks in length
	 * 
	 * @param clockTicks
	 *            number of clocks to repeat value
	 * @param value
	...
	/**
	 * Create a repeating pin value based on a specified float which is certain
	 * number of clocks in length
	 * 
	 * @param clockTicks
	 *            number of clocks to repeat value
	...
	/**
	 * Create a repeating pin value based on a specified double which is certain
	 * number of clocks in length
	 * 
	 * @param clockTicks
	 *            number of clocks to repeat value
	...
	/**
	 * Create a repeating pin value based on a specified long which is certain
	 * number of clocks in length, which increments by a certain value as it
	 * repeats. The value may be negative.
	 * 
	 * @param clockTicks
	 *            number of clocks to repeat value
	 * @param value
	 *            value to repeat
	 * @param increment
	 *            value to increment by as you repeat
	 */
