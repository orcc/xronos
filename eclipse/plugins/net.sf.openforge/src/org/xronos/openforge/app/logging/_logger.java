 ...
 * Use like this:
 * 
 * if (_logger.db) { _logger.ln("ugh"); }
 * 
 * if (_logger.db) { _logger.ln("glub"); }
 * 
 ************************************* 
 * 
 ...
 * _logger.ln("Blug"); it is the default level.
 * 
...
public class _logger {
	...
	private final static Debug debug = new Debug(
			org.xronos.openforge.app.logging._logger.class, TAG, db, VISIBLE,
			ForgeLogger.consoleErr);
