 ...
 * which specifies grouping information. An unspecified tag places the Option in
 * the default OptionDB.GLOBAL group. The OptionDB.CONFIG group is a special
 * designation used for Options which relate to configuration information rather
 * than processing constraints (ie, directory locations, search paths,
 * verbosity, etc). Other special groups can be created as needed.
 * 
...
public abstract class Option {
	 ...
	 */
	public Option(OptionKey key, String default_value, boolean hidden) {
		this.optionKey = key;
	...
	/**
	 * Returns a String indicating the type of value that is valid for this type
	 * of option.
	 * 
	 * @return a non-null String, may be zero length if no value is to be
	 *         supplied.
	 */
	...
	/*
	 * public String toString() { return new String("Option -- " + getKey() +
	 * " default:{" + getDefault() + "}" + " brief:\"" + getBriefDescription() +
	 * "\"" + " long:\"" + getDescription() + "\"" + " cli: " + (hasCLI() ?
	 * ("\"" + getCLI() + "\"") : "none") + " hidden? " + (hidden ? "yes" :
	 * "no") ); }
	 */

	public void printXML(IndentWriter printer, String value) {
		printer.println("<option name=\"" + getOptionKey().getKey() + "\" "
				+ "type=\"" + getTypeName() + "\">" + value + "</option>");
	}
	 ...
	 */
	public abstract void expand(List<String> tokens);

	/**
	 * This method sets the value to the option. The validity check on the
	 * 'value' is performed in the different Option<Type> classes.
	 * 
	 * @param slabel
	...
	/**
	 * Gets the value associated with the option. It uses the SearchLabel to get
	 * a list of scopes to search the value for and returns the value of the
	 * first matching scope. If no matching scope is found, it returns the
	 * default value of the option. This method NEVER returns null.
	 * 
	 * @param slabel
	 *            label to search for scope
	 * @return Object - value of the option
	 */
	public Object getValue(SearchLabel slabel) {
		List<String> labelList = slabel.getSearchList();
	...
	/**
	 * Gets the value associated with the option at a particular scope. It uses
	 * the scope to get the value for the option at that scope. If no value
	 * exists at that scope, it returns null.
	 * 
	 * @param scope
	 *            the particular scope at which the value is to be searched.
	 * @return Object - value of the option
	 */
	...
	/**
	 * This method replaces the current value in the localMap with the value
	 ...
	 * 
	 * @param s
	 *            the string version of a possible value
