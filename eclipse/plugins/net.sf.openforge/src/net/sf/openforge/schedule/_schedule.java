 ...
 * Use like this:
 * 
 * if (_schedule.db) { _schedule.ln("ugh"); }
 * 
 * if (_schedule.db) { _schedule.ln("glub"); }
 * 
 ************************************* 
 * 
 ...
 * _schedule.ln("Blug"); it is the default level.
 * 
...
public class _schedule {
	...
	private final static Debug debug = new Debug(_schedule.class, TAG, db,
			VISIBLE);
