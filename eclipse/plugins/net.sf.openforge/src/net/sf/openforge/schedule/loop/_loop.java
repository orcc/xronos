...
public class _loop
{
    private static final String _RCS_ = "$Rev: 94 $";

    // Add your tag here!
    public final static String TAG = "ScheduleLoop";
    ...
    private final static Debug debug = new Debug(_loop.class, TAG, db, VISIBLE);
