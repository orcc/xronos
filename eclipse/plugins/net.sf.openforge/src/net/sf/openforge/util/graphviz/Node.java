...
public abstract class Node extends GVObject {
	...
	/**
	 * Gets the graph to which this node has been added, or null if this node
	...
	/**
	 * Gets the name that should be used to identify this node when used as the
	 * source of an edge. By default, the same as the identifier.
	 */
	...
	/**
	 * Gets the name that should be used to identify this node as the target of
	 * an edge. By default, the same as the identifier.
	 */
