...
public class Edge extends GVObject {
	...
	/**
	 * Sets the direction of this edge, as indicated by arrows at the ends.
	 * 
	 * @param direction
	 *            one of DIR_FORWARD, DIR_BACK, DIR_BOTH, or DIR_NONE
	 */
	public void setDirection(String direction) {
		assert (direction.equals(DIR_FORWARD) || direction.equals(DIR_BACK)
				|| direction.equals(DIR_BOTH) || direction.equals(DIR_NONE)) : "Invalid Edge direction: "
				+ direction;
	 ...
	 * 
	 * @param style
	 *            one of STYLE_DASHED, STYLE_DOTTED, STYLE_BOLD, or STYLE_NONE
	 */
	public void setStyle(String style) {
		assert (style.equals(STYLE_DASHED) || style.equals(STYLE_DOTTED)
				|| style.equals(STYLE_BOLD) || style.equals(STYLE_NONE)) : "Invalid Edge style: "
				+ style;

		setAttribute("style", style);
	}
	// /**
	// * sets the port of the head and tail of the edge. Port is the quadrant of
	// the node that the edge connects to - there are _NO_ buses
	// * @param headPort
