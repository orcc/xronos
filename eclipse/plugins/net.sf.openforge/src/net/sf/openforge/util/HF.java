...
public class HF {
	 ...
	 * @see
	 */
	private final static String z(String s, int w) {
	 ...
	 *            long
	 */
	public final static String hex(long i) {
	 ...
	 *            width to pad to
	 */
	public final static String hex(long i, int w) {
		return z(hex(i), w);
	}
	 ...
	 *            width to pad to
	 */
	public final static String hex(int i, int w) {
		return z(hex(i), w);
	}
	 ...
	 *            width to pad to
	 */
	public final static String hex(short i, int w) {
		return z(hex(i), w);
	}
	 ...
	 *            width to pad to
	 */
	public final static String hex(byte i, int w) {
		return z(hex(i), w);
	}

	/**
	 * Return String of hexDump of a byte buffer, nicely formatted with offsets
	 * displayed.
	 * 
	 * @return String
	 * 
	 ...
	 * 
	 * @param os
	 *            OutputStream to dump hexDump to
	 * @param []buf byte buffer to dump
	 * @param off
	 *            offset to start at
	 * @param len
	 ...
	 * 
	 * @param pw
	 *            PrintWriter to dump hexDump to
	 * @param []buf byte buffer to dump
	 * @param off
	 *            offset to start at
	 * @param len
