...
import net.sf.openforge.optimize.constant.FullConstantVisitor;
import net.sf.openforge.optimize.constant.HalfConstantVisitor;
import net.sf.openforge.optimize.constant.TwoPassPartialConstant;
import net.sf.openforge.optimize.io.BlockElementRemover;
import net.sf.openforge.optimize.loop.LoopUnrollingVisitor;
import net.sf.openforge.optimize.loop.LoopVariableResizer;
import net.sf.openforge.optimize.memory.BaseAddressUniquifier;
import net.sf.openforge.optimize.memory.MemoryReducer;
import net.sf.openforge.optimize.memory.MemorySplitter;
import net.sf.openforge.optimize.memory.MemoryToRegister;
import net.sf.openforge.optimize.memory.MemoryTrimmer;
import net.sf.openforge.optimize.memory.ReadOnlyFieldReducer;
import net.sf.openforge.optimize.memory.RomReplicator;
import net.sf.openforge.optimize.nesting.NestedBlockOptimization;
...
public class Optimizer {
	...
	public Visitable optimize(Design target) {
		...
		(new net.sf.openforge.schedule.block.CallUnnesting(false))
				.flattenCalls(target);
