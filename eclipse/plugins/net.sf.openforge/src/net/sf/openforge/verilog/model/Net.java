 ...
 * and size. When used as directly, the Net represents itself with just the
 * identifier. Utility methods are available for creating sub-nets, ranged
 * LValues, and more.
 * <P>
...
public abstract class Net implements NetLValue, SimpleExpression {
	...
	/**
	 * Net.Range is a Net which presents the fully qualified Net (identifier
	 * plus a range). If MSB==LSB, then the Range is presented as a bit select.
	 * <P>
	 * Example:<BR>
	 * <CODE><PRE>
	 * a[32:0]
