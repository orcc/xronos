...
public class Lexicality {
	...
	/**
	 * The number of elements (Tokens and plain VerilogElements) in this
	 * Lexicality. This is not a cumulative accounting of all Tokens accessible
	 * through a LexicalIterator (which extracts all tokens from sub-levels).
	 * 
	 */
	public int size() {
		return tokens.size();
	...
	/**
	 * Produces a mildly formatted String comprised of each Token, with some
	 * whitespace interspersed. This is not intended to be used for production
	 * quality code. It is here only for convenience and quick debug.
	 * <P>
	 * Preferably, a custom rule-based writer would process all the tokens
