 ...
 * debug.internal.<tag> = true|false or the environment variable: -
 * DEBUG_INTERNAL_<tag> = true|false
 * 
 * By default, your outputs are using the DEFAULT level. I.e., if you use
 * _memory.ln("Blug"); it is the default level.
 * 
...
public class _memory {
	// Add your tag here!
	public final static String TAG = "memory";
	...
	public static final int BUILD = 0x2;
	public static final int MEMVISIT = 0x4;
	...
	private final static Debug debug = new Debug(
			net.sf.openforge.lim.memory._memory.class, TAG, db, VISIBLE, STRUCT
					| BUILD);
