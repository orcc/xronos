...
public class OrOp extends BinaryOp implements Emulatable {
	...
	/**
	 * Pushes size, care, and constant information forward through this OrOp's
	 * result bus.
	 * 
	...
	public boolean pushValuesForward() {
		...
		if (getRightDataPort() == null) {
			...
			final int compactedSize = Math.min(newValue.getCompactedSize(),
					minPortSize);
	...
	/**
	 * Reverse constant prop on an OrOp simply propagates the result bus value
