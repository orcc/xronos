...
/**
 * ActorPort is an interface which will be implemented by all the various
 * flavors of Actor ports and provides methods which are needed to create the
 * various types of accesses which are possible on an Actor port.
 * 
 * 
 * <p>
 * Created: Mon Aug 29 10:55:36 2005
 * 
...
public interface ActorPort {
	 ...
	 * 
	 * @param blocking
	 *            if set true the returned access is a blocking access,
	 *            otherwise it is a simple access of the data (non-blocking).
	 */
	public Component getAccess(boolean blocking);

	/**
	 * Returns a component which tests the current number of tokens in the
	 * channel.
	 */
	public Component getCountAccess();

	/**
	 * Returns a component which peeks at the value at a depth into the channel
	 * queue specified by an index port.
	 */
