...
/**
 * RegisterAccessBlock is a Module which contains the Register Access component
 * ({@link RegisterRead} or {@link RegisterWrite}) as well as any necessary
 * conversion logic such as casts to preserve correct signedness. This block is
 * needed because Registers always consider their stored value to be unsigned,
 * and thus the accesses must convert their data values to/from unsigned to
 * preserve correct functionality.
 * 
 * 
 * <p>
 * Created: Fri Oct 24 10:55:49 2003
 * 
...
public class RegisterAccessBlock extends Block {
	...
	/**
	 * Returns the contained RegisterRead or RegisterWrite Access, used
	...
	/**
	 * A RegisterAccessBlock that contains a RegisterRead and a cast to convert
	 * the value retrieved from the register to a signed/unsigned value as
	 * needed.
	 */
	public static class RegisterReadBlock extends RegisterAccessBlock {
		public RegisterReadBlock(RegisterRead acc) {
			...
			CastOp convert = new CastOp(
					((Register) acc.getResource()).getInitWidth(),
					acc.isSigned());
			...
			/*
			 * Connect the RegisterRead's data output to the output of this
			 * module.
			 */
	...
	/**
	 * A RegisterAccessBlock that contains a RegisterWrite and a cast to convert
	 * the value written to the register to an unsigned value as required by the
	 * target Register.
	 */
