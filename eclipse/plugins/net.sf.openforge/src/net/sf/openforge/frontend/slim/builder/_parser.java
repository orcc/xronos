 ...
 * Use like this:
 * 
 * if (_parser.db) { _parser.ln("ugh"); }
 * 
 * if (_parser.db) { _parser.ln("glub"); }
 * 
 ************************************* 
 * 
 ...
 * _parser.ln("Blug"); it is the default level.
 * 
...
public class _parser {
	...
	private final static Debug debug = new Debug(_parser.class, TAG, db,
			VISIBLE);
