...
/**
 * A ClockDomain pairs a ClockPin with a ResetPin, and associates
 * {@link EntryMethod EntryMethods} which operate within the same clock domain.
 * <P>
...
public class ClockDomain {
	...
	public final static ClockDomain GLOBAL = new ClockDomain("CLK",
