...
/**
 * This transformation replaces all Variables different variables defined in
 * each pattern with a single one that has the maximum numTokens, also replace
 * the loads and the stores that this pattern variable is used.
 * 
 * @author Endri Bezati
 *
 */
public class SinglePortList extends DfVisitor<Void> {
