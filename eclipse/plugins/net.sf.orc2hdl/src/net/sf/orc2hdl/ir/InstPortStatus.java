 ...
 * </p>
 *
 * @see net.sf.orc2hdl.ir.ChronosIrSpecificPackage#getInstPortStatus()
 * @model
 * @generated
 */
public interface InstPortStatus extends InstSpecific {
	 ...
	 * @see #setPort(Vertex)
	 * @see net.sf.orc2hdl.ir.ChronosIrSpecificPackage#getInstPortStatus_Port()
	 ...
	 * @see #setTarget(Def)
	 * @see net.sf.orc2hdl.ir.ChronosIrSpecificPackage#getInstPortStatus_Target()
