 ...
 * <em><b>Inst Port Peek</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.xronos.orcc.ir.impl.InstPortPeekImpl#getTarget <em>Target</em>}
 * </li>
...
public class InstPortPeekImpl extends InstSpecificImpl implements InstPortPeek {
	...
	protected EClass eStaticClass() {
		return XronosIrSpecificPackage.Literals.INST_PORT_PEEK;
	}
	...
	public NotificationChain basicSetTarget(Def newTarget,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					XronosIrSpecificPackage.INST_PORT_PEEK__TARGET, oldTarget,
					newTarget);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public void setTarget(Def newTarget) {
		if (newTarget != target) {
				...
				msgs = ((InternalEObject) target)
						.eInverseRemove(
								...
								EOPPOSITE_FEATURE_BASE
										- XronosIrSpecificPackage.INST_PORT_PEEK__TARGET,
								null, msgs);
			}
			if (newTarget != null) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					XronosIrSpecificPackage.INST_PORT_PEEK__TARGET, newTarget,
					newTarget));
		}
	}
	...
	public void setPort(Vertex newPort) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET,
					XronosIrSpecificPackage.INST_PORT_PEEK__PORT, oldPort, port));
		}
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case XronosIrSpecificPackage.INST_PORT_PEEK__TARGET:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case XronosIrSpecificPackage.INST_PORT_PEEK__TARGET:
			return getTarget();
		case XronosIrSpecificPackage.INST_PORT_PEEK__PORT:
			return getPort();
		}
