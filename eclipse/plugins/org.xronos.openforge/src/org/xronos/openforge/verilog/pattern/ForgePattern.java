...
/**
 * A Forge pattern is a verilog Statement which distinguishes between consumed
 * and produced {@link Net Nets}. Consumed Nets typically provide "input"
 * signals to the statement, and should be declared by another block which
 * provides their value. Produced Nets are the "output" signals which are the
