 ...
 * Use like this:
 * 
 * if (_pattern.db) { _pattern.ln("ugh"); }
 * 
 * if (_pattern.db) { _pattern.ln("glub"); }
 * 
 ************************************* 
 * 
 ...
 * _pattern.ln("Blug"); it is the default level.
 * 
...
public class _pattern {
	...
	private final static Debug debug = new Debug(
			org.xronos.openforge.verilog.pattern._pattern.class, TAG, db, VISIBLE);
