...
import org.xronos.openforge.verilog.model.IntegerWire;
import org.xronos.openforge.verilog.model.Math;
import org.xronos.openforge.verilog.model.Module;
import org.xronos.openforge.verilog.model.ProceduralTimingBlock;
import org.xronos.openforge.verilog.model.RealWire;
...
class BenchMarker {
	...
	public void stateLogic(Module module, StateMachine mach, Design design) {
		...
		AllGos.add(new Assign.Blocking(benchNumReads,
				new org.xronos.openforge.verilog.model.Math.Add(benchNumReads,
