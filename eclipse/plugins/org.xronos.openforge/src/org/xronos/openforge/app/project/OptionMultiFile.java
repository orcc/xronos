...
public class OptionMultiFile extends OptionFile {
	...
	/**
	 * @see org.xronos.openforge.app.project.Option#getTypeName()
	 */
	@Override
	...
	/**
	 * @see org.xronos.openforge.app.project.Option#isValid(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see org.xronos.openforge.app.project.Option#printXML(org.xronos.openforge.util.IndentWriter,
	 *      java.lang.String)
	 */
	@Override
