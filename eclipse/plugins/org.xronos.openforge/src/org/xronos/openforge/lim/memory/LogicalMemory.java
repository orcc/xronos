 ...
 */
public class LogicalMemory extends org.xronos.openforge.util.naming.ID
		implements MemoryVisitable, StateHolder, Referenceable {
	...
	private class Accessor_ {
		...
		public void debug() {
			...
			for (Location location : getTargets()) {
	...
	public Collection<Location> getAccesses(LValue lvalue) {
		...
		return accessor == null ? Collections.<Location> emptyList() : accessor
				.getTargets();
	}
