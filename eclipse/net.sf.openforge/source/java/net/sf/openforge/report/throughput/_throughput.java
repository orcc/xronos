 ...
 *
 */
public class _throughput
{
    private static final String _RCS_ = "$Rev: 2 $";
    // Add your tag here!
    public final static String TAG = "throughput";
    ...
    private final static Debug debug = new Debug(_throughput.class,
                                                 TAG,db,VISIBLE);
    public final static Debug d = debug; // backwards compatibility with previous version

    public final static int TA   = 0x2;
    public final static int GLV  = 0x1;
