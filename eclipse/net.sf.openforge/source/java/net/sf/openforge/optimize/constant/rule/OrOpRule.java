...
public class OrOpRule 
{
    ...
    public static boolean halfConstant(OrOp op, Number[] consts, ComponentSwapVisitor visit)
    {
        ...
        else if(constant.longValue() == -1)
        {
            ...
            visit.replaceComponent(op, new Constant(-1, op.getResultBus().getValue().getSize(), op.getResultBus().getValue().isSigned()));
