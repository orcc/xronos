...
/**
 * Compare provides a collection of nested classes to represent comparison operations.
...
public abstract class Compare extends Operation
{
    ...
    public static final class GT extends Compare
    {
        ...
        public int precedence() { return GT_PRECEDENCE; }
    ...
    public static final class LT extends Compare
    {
        ...
        public int precedence() { return LT_PRECEDENCE; }
        public boolean isOrdered() { return true; }
    ...
    public static final class GTEQ extends Compare
    {
        ...
        public int precedence() { return GTEQ_PRECEDENCE; }
        public boolean isOrdered() { return true; }
    ...
    public static final class LTEQ extends Compare
    {
        ...
        public int precedence() { return LTEQ_PRECEDENCE; }
        public boolean isOrdered() { return true; }
    ...
    public static final class EQ extends Compare
    {
        ...
        public int precedence() { return LOGICAL_EQUALITY_PRECEDENCE; }
        public boolean isOrdered() { return true; }
    ...
    public static final class NEQ extends Compare
    {
        ...
        public int precedence() { return LOGICAL_INEQUALITY_PRECEDENCE; }
        public boolean isOrdered() { return true; }
    ...
    public static final class CASE_EQ extends Compare
    {
        ...
        public int precedence() { return CASE_EQUALITY_PRECEDENCE; }
        public boolean isOrdered() { return true; }
    ...
    public static final class CASE_NEQ extends Compare
    {
        ...
        public int precedence() { return CASE_INEQUALITY_PRECEDENCE; }
        public boolean isOrdered() { return true; }
