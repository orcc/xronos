...
/**
 * ConditionalOp is the super class of all comparison operations (gt,
 * gte, lt, lte, ne, eq) and provides a setFloat method to override
 * the functionality in BinaryOp.  This is necessary because even
 * though a conditional may take in 2 float values (and thus is a
 * floating point comparison) it will return an int/boolean and thus
 * we cannot rely on its result bus to determine its type.
 *
 *
 * <p>Created: Thu May  1 16:08:46 2003
 *
...
public abstract class ConditionalOp extends BinaryOp 
{
    ...
    /**
     * Returns true if this operation has been marked as floating
