 ...
 * performed before each iteration.  ForBody is composed
...
public class ForBody extends LoopBody implements Cloneable
{
    ...
    /**
     *
     * Constructs a ForBody and establishes control dependencies
     * between the decision, body and perimeter of the ForBody.
     *
    ...
    protected void setControlDependencies ()
    {
        ...
        if ((bodyDoneExit == null) && (bodyContinueExit == null))
        {
             ...
             * exits with a 'continue'.  If neither Exit exits, remove the Module.
             */
        ...
        else
        {
             ...
             * into one OutBuf/Exit before connecting to the update;
             ...
             * on the update Module.
             */
            if (bodyDoneExit != null)
            {
                exitMap.remove(bodyDoneExit.getTag());
                final Entry updateEntry = getUpdate().makeEntry(bodyDoneExit);
                addDependencies(updateEntry, clockBus, resetBus, bodyDoneExit.getDoneBus());
            }
            else if (bodyContinueExit != null)
            {
                exitMap.remove(bodyContinueExit.getTag());
                final Entry updateEntry = getUpdate().makeEntry(bodyContinueExit);
                addDependencies(updateEntry, clockBus, resetBus, bodyContinueExit.getDoneBus());
            }
        ...
        /*
         * Feedback Exit is comprised of Update Component done
         * and CONTINUE Exit, if any.  There may be no feedback exits
         * if the body ends with a break.
         */
        ...
        /*
         * Completion Exit is comprised of Decision false and body's
         * BREAK Exit, if any.
         */
