...
public class AndOp extends BinaryOp implements Emulatable
{
    ...
    public boolean pushValuesForward ()
    {
        ...
        else
        {
            ...
            while (portIter.hasNext())
            {
                ...
                final int compactedSize = Math.min(newValue.getSize(), Math.max(newValue.getCompactedSize(), nextPort.getValue().getCompactedSize()));
                ...
                {
                    if (!newValue.isConstant() || !nextPort.getValue().isConstant())
                    {
    ...
    /**
     * Reverse constant prop on an AndOp simply propagates the
    ...
    /**
     * Produces a Value representing the state after ANDing the two
