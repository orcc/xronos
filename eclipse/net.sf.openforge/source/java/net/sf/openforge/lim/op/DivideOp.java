...
//         return OperationReplacementVisitor.DIVNAME;
        ...
        // FIXME: Do this until Ian resolves the problems with OperationReplacementVisitor.
        return "div";
    }
     ...
     * this DivideOp according to this rule:
     *
     * Result size is port 0 size.  
    ...
    /**
     * Reverse constant prop on a DivideOp simply propagates the
     * consumed value back to the Ports. The first port has the same size
     * with the consumed value, and all bits are care.
     *
     * @return a value of type 'boolean'
     */
    public boolean pushValuesBackward ()
    {
        ...
        Value pushBackValue = new Value(resultBusValue.getSize(), resultBusValue.isSigned()); 
