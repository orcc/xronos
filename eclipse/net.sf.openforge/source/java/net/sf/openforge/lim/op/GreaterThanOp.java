 ...
 *
 * @author  Conor Wu
 * @version $Id: GreaterThanOp.java 2 2005-06-09 20:00:48Z imiller $
 */
public class GreaterThanOp extends ConditionalOp implements Emulatable
{
    private static final String _RCS_ = "$Rev: 2 $";

    /**
     * Constructs a relational greater than operation.
     *
     */
     ...
     * this GreaterThanOp according to this rule:
     *
    ...
    /**
     * No rules can be applied on a GreaterThanOp.
     *
     * @return a value of type 'boolean'
     */
