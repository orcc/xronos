...
public class RightShiftUnsignedOp extends ShiftOp implements Emulatable
{
    ...
    public Map emulate (Map portValues)
    {
        ...
        return Collections.singletonMap(getResultBus(), lval.shiftRightUnsigned(rval));
    }
     ...
     * this RightShiftUnsignedOp according to these rules:
     * 
    ...
    /**
     * Reverse constant prop on a RightShiftUnsignedOp applies only if the
