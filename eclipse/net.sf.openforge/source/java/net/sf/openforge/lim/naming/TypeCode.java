...
public class TypeCode
{
    ...
    /**
     * Produces a string which is appropriate for representing
     ...
     * a class type.
     *
     * @param info the IDSourceInfo which identifies the class
     */
    ...
    {
        if (!(o instanceof TypeCode)) return false;
     ...
     * 
     * @param typecodes the array of typecodes
