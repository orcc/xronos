...
public class GlobalReset extends HiddenPin
{
    ...
    public static class Physical extends Block
    {
        ...
        public Physical (boolean publishReset)
        {
            ...
            sampleReg.setInitialValue(zeroValue); // ensures constant prop does not eliminate
            ...
            crossReg.setInitialValue(zeroValue); // ensures constant prop does not eliminate
            ...
            glitchReg.setInitialValue(zeroValue); // ensures constant prop does not eliminate
