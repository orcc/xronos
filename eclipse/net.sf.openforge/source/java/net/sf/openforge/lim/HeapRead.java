...
/**
 * HeapRead is an {@link OffsetMemoryRead} whose offset value is a constant
 * that is assigned according to a symbol that is supplied with the constructor.
 *
...
public class HeapRead extends OffsetMemoryRead
{
     ...
     * this memory access.
     */
    public HeapRead (int addressableLocations, int maxAddressWidth,
        int offset, boolean isSigned, AddressStridePolicy policy)
    {
...
//             addressableLocations, maxAddressWidth, offset);
     ...
     * and the first location to be read
     * @param isSigned, true if this is a signed access
     * @param accessBitWidth the number of unoptimized bits in the
     * memory access.
     */
    public HeapRead (int addressableLocations, int maxAddressWidth,
     ...
     * and the first location to be read
     */
    private HeapRead (MemoryRead memoryRead, int addressableLocations, int maxAddressWidth, int offset)
    {
     ...
     *
     * @return the number of addressable locations between the base
     * address and the first location to be read
     */
    ...
    public Object clone () throws CloneNotSupportedException
    {
        ...
        final HeapRead clone = new HeapRead(
            cloneRead, 
    ...
    protected void cloneNotify (Module moduleClone, Map cloneMap)
    {
        ...
        ((HeapRead)moduleClone).offsetConstant = (Constant)cloneMap.get(this.offsetConstant);
    }
}
