...
public class EntryMethods
{
    ...
    private static final HashSet entrySet = new HashSet();
     ...
     */
    public static Set getEntryMethods()
    {
        return entrySet;
    }
     ...
     */
    public static Set cloneEntryMethods()
    {
        return (Set)entrySet.clone();
    }
     ...
     *
     * @param s a value of type 'Set'
     *
     */
    public static void setEntryMethods(Set s)
    {
        entrySet.addAll(s);
    }
     ...
     *
     * @param em the EntryMethod to look for
     ...
     *
     * @param em the EntryMethod to add.
    ...
    public static boolean add(EntryMethod em)
    {
        ...
        if(ret)
        {
            ...
            {
                RunThread rt = new RunThread(em.getObject(), em.getObjectClass(), em.getMethod());
...
class RunThread extends java.lang.Thread
{
    ...
    public void run()
    {
        ...
        try
        {
            // Make accessable, incase its private or package protected, then call
            method.setAccessible(true);
            method.invoke(obj,new Object[0]);
        }
        catch(IllegalAccessException iae)
        {
            System.err.println("ERROR: IllegalAccessException when creating Thread for Entry Method: " + className + "." + methodName);
        }
        catch(IllegalArgumentException iae)
        {
            System.err.println("ERROR: IllegalArgumentException when creating Thread for Entry Method: " + className + "." + methodName);
        }
        catch(InvocationTargetException ite)
        {
            System.err.println("ERROR: InvocationTargetException when creating Thread for Entry Method: " + className + "." + methodName);
        }
        catch(NullPointerException npe)
        {
            System.err.println("ERROR: NullPointerException when creating Thread for Entry Method: " + className + "." + methodName);
        }
        catch(ExceptionInInitializerError eiie)
        {
            System.err.println("ERROR: ExceptionInInitializerError when creating Thread for Entry Method: " + className + "." + methodName);
        }
        catch(Throwable e)
        {
            System.err.println("ERROR: Exception: " + e.getMessage() +
                               " when creating Thread for Entry Method: " + className + "." + methodName);
        }
    }
