...
/**
 * ClockPin is a specific type of <code>Buffer</code> that represents
 * a clock input to the design.  <code>ClockPin</code>s are identified
 * by the specific name used to create them and their speed, measured
 * in Hz.
 */
public class ClockPin extends ControlPin
{
    ...
    /**
     * Constructs a new ClockPin with default name CLK which is active
     * high and has and undefined frequency.
     */
    protected ClockPin()
    {
        super("CLK");
    ...
    /**
     * Constructs a new named ClockPin which is active high and has
     * and undefined frequency.
     * 
     * @param name, the String name of this ClockPin
     */
     ...
     * 
     * @param name, the String name of this ClockPin
     * @param Hz, the frequency of this ClockPin in Hz
     */
    ...
    /**
     * Gets the {@link ResetPin} which is in the same domain as this
     * clock.
     */
