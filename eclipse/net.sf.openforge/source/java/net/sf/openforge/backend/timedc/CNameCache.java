...
/**
 * CNameCache is a simple name cache which ensures a unique base name
 * for each component.  This class also ensures that the generated
 * base name is a legal C identifier.
 *
 *
 * <p>Created: Wed Apr 13 15:59:27 2005
 *
...
public class CNameCache 
{
    ...
    /**
     * Returns the cached and unique String name for the given
     * component.  The name is guaranteed to be legal C syntax.
     *
    ...
    /**
     * Ensures that the given string is not a value in the cache map,
     * and appends _# where # is the lowest integer necessary to make
     * the string unique.
     *
    ...
    /**
     * Returns a String in which any illegal characters (for a C
     * identifier) in the input string have been replaced with legal
     * characters. 
     *
     * @param s a value of type 'String'
     * @return a value of type 'String'
