...
{
    final static String rcs_id = "RCS_REVISION: $Rev: 2 $";
     ...
     *@param  wait     Description of the Parameter
     */
     ...
     *
     *@param  tracker       Description of the Parameter
     *@param  lastLocation  Description of the Parameter
     *@param  tag           Description of the Parameter
     *@param  history       Description of the Parameter
     *@param  o             Description of the Parameter
     *@param  wait          Description of the Parameter
     *@param  cloned        Description of the Parameter
     */
    ShineTableFrame(ShineTracker tracker,
        Point lastLocation,
        String tag,
        Stack history,
        Object o,
    ...
    Component createToolBar()
    {
        ...
        clearWaitButton.addActionListener(
            new ActionListener()
            {
                public void actionPerformed(ActionEvent e)
                {
     ...
     *  Description of the Method
     *
     *@param  makeTable  Description of the Parameter
     */
     ...
     *  {
     *  / can't clone a cloned ...
     *  / not so tough. add the current objec to our stack
     *  history.push(oi.getMyObject());
     *  / now clone it.
     *  try
     *  {
     *  Stack newStack=(Stack)cloneWithEngine(history);
     *  / get rid of the prior object
     *  history.pop();
     ...
     *  true);
     *  }
     *  catch(GraphIOException gie)
     *  {
     *  System.out.println(gie);
     *  }
     *  }
     *  private static GraphClone cloneEngine=new GraphClone();
     *  private static synchronized Object cloneWithEngine(Object o)
     *  throws GraphIOException
     *  {
     *  return cloneEngine.cloneGraph(o);
     *  }
     */
    class Sep extends JComponent
    {
         ...
         *@param  etchIn     Description of the Parameter
         */
         ...
         *
         *@param  thickness    Description of the Parameter
         *@param  topleftGap   Description of the Parameter
         *@param  botrightGap  Description of the Parameter
         *@param  etchIn       Description of the Parameter
         */
        public Sep(int thickness, int topleftGap, int botrightGap, boolean etchIn)
        {
        ...
        {
            Dimension d = getSize();
            Color from = etchIn ? SystemColor.controlDkShadow : SystemColor.controlHighlight;
            Color to = etchIn ? SystemColor.controlHighlight : SystemColor.controlDkShadow;
