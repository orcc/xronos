...
/**
 * <code>SizedInteger</code> is a class for performing integer computations
 * of a fixed size in either signed or unsigned ranges.  This is useful for
 * emulating operations of primitive programming types, e.g. addition of
 * signed 32-bit numbers, subtraction of unsigned 8-bit numbers, etc.
 * <P>
 * For each operation, the size and sign range of the result is the same
 * as that of the operands.  For most binary operations, the sign range and
 * size of the operands must agree.  Note that instances of this class are
 * immutable.
 *
...
public class SizedInteger
{
    ...
    /**
     * Always positive -- basically just an array of two's-complement bits;
     * bits at index >= size are never set, as if they don't exist.
     */
    private BigInteger bits;

    /** The number of significant bits; if isSigned is true, the MSB is a sign bit */
    private int size;
     ...
     *
     * @param number the bits of the number
     * @param size the number of significant bits in the return value
     * @param isSigned the sign range of the return value
    ...
    /**
     * Gets a new <code>SizedInteger</code> representation.  This form is
     * useful when there are more bits than will fit in a <code>long</code>.
     *
     * @param number the bits of the number
     * @param size the number of significant bits in the return value
     * @param isSigned the sign range of the return value
     * @return a new <code>SizedInteger</code> for the specified value
     */
    public static SizedInteger valueOf (BigInteger number, int size, boolean isSigned)
    {
    ...
    /**
     * Gets the result of converting this value to one with a given
     * size and sign.
     *
     * @param size the size to conver to
     * @param isSigned true if the converted value is signed, false otherwise
     * @return the converted value, or <code>this</code> if no conversion is
     *         necessary
     */
    public SizedInteger convert (int size, boolean isSigned)
    {
        return ((size == getSize()) && (isSigned == isSigned())
            ? this
     ...
     * @return true if the given object is a <code>SizedInteger</code> with
    ...
    public boolean equals (Object object)
    {
        if (object instanceof SizedInteger)
        {
            ...
            return s.bits.equals(bits) && (size == s.getSize()) && (isSigned() == s.isSigned());
        }
        return false;
    }
     ...
     *
     * @param i the bit position, 0 <= <code>i</code> < {@link #getSize()}
     * @return true if the bit is set, false if it is clear
     * @exception IndexOutOfBoundsException if the given position is out of range
     */
     ...
     *
     * @param n a <code>SizedInteger</code> value
     * @return the result of the addition
     * @throws IllegalArgumentException if <code>n</code> does not have the
     *           same sign range or sign as this instance
     */
    ...
    /**
     * Compares this SizedInteger with the specified SizedInteger. This method is
     ...
     *
     * @param n SizedInteger to which this instance is to be compared
     * @return -1, 0 or 1 as this SizedInteger is numerically less than, equal to,
     *         or greater than <code>n</code>
     * @throws IllegalArgumentException if <code>n</code> does not have the
     *           same sign range or sign as this instance
     */
     ...
     *
     * @param n the SizedInteger by which this instance is to be divided
     ...
     * SizedInteger.
     *
     * @param n the SizedInteger by which this instance is to be mod'd
    ...
    /**
     * Gets the value of multiplying this SizedInteger by a given
     * SizedInteger.
     *
     * @param n the SizedInteger by which this instance is to be multiplied
     ...
     *
     * @param n the SizedInteger with which this instance is or'd
    ...
    /**
     * Gets the result of shifting this SizedInteger to the left by a
     * given SizedInteger number of bits.
     *
     * @param n the number of bits by which this value is to be shifted left
    ...
    public SizedInteger shiftLeft (SizedInteger n)
    {
        ...
        for (BigInteger i = BigInteger.ZERO; i.compareTo(magnitude) < 0; i = i.add(BigInteger.ONE))
        {
    ...
    /**
     * Gets the result of shifting this SizedInteger to the right by a
     * given SizedInteger number of bits.  If this value is signed, then
     * sign extension will be performed; otherwise it will not.
     *
     * @param n the number of bits by which this value is to be shifted right
     * @return the result of the shift
     */
    ...
    /**
     * Gets the result of shifting this SizedInteger to the right by a
     * given SizedInteger number of bits.  Sign extension is not performed;
     * zero is used to fill.
     *
     * @param n the number of bits by which this value is to be shifted right
     * @return the result of the shift
     */
     ...
     *
     * @param n the SizedInteger to be subtracted from this instance
    ...
    /**
     * Gets the result of performing an exclusive-or of this SizedInteger
     * with a given SizedInteger.
     *
     * @param n the SizedInteger to be xor'd with this one
    ...
    public BigInteger numberValue ()
    {
        ...
        {
            /*
             * If negative, use two's-complement conversion to
             * get the magnitude and negate it.
             */
    ...
    private static void checkArgs (SizedInteger i, SizedInteger j) throws IllegalArgumentException
    {
        ...
        {
            throw new IllegalArgumentException("incompatible sign: "
                + i + " signed=" + i.isSigned() + ", " + j + " signed=" + j.isSigned());
        }
    }
