...
public class JavaC
{
     ...
     */
    public JavaC(String sourceFile,
                 PrintStream out,
                 ...
                 PrintStream err) throws IOException
    {
        ...
        {    
            ...
            String javac = javaHome + File.separator + ".." +
    ...
    public void compileInternal ()
    {
        if (isJavaSource())
        {
            ...
            /*
             * Need $JAVA_HOME/lib/tools.jar in the classpath to
             * compile and run this line:
             */
    ...
    public String getOutputClass() throws FileNotFoundException
    {
        ...
        if(compileOK())
        {
            ...
            } else
            {
                ...
                // OK, build the target class file based on the package, destination dir,
    ...
    class PackageKeywordParser
    {
        ...
        private String next() throws IOException
        {
            ...
            // consider a statement line to be what is left that ends with ; or { or }
        ...
        {
            // blow through source file until we find { or EOF, looking for a line
