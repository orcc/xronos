...
public class InstanceInspector implements Comparator
{
    ...
    public String toString()
    {
        ...
        {
            pw.println("\t" + getModifierString(i) + getField(i) + " == " + getFieldValue(i));
        }
    ...
    throws IllegalArgumentException
    {
        ...
        for(int i=0;i<order.length();i++)
        {
            if(_possibleOrders.indexOf(order.charAt(i))<0)
                throw new IllegalArgumentException("Illegal Sort option: "+order.charAt(i));
        }
    ...
    /**
     * Comparator for the field ordering. -1 if o1 comes before o2,
     * 0 if the are equal, +1 if o1 comes after o2
     *
