...
public class LADomain
{
     ...
     * or complicated (like an entire preference set). This tag object will
     * be available on each adaptor callback.
     *
     * @param tag Any object which should be made available to the callbacks
     */
    ...
    /**
     * Add a Listener/Adapter handler to the list. The same LAHandleable
     * may be added more than once; in this case it will fire more than once
     * per event.
     *
     * @param lah a value of type 'LAHandleable'
     */
    ...
    public final Iterator getListenerIterator() { return listeners.iterator(); }

    /**
     * Fires all the adapters currently listening for this domain. 
     *
     * @param passthru Object to passthru.
     */
