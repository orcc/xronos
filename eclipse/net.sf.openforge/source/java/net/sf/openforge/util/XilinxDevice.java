...
public class XilinxDevice
{
    ...
    static
    {
        ...
        ArrayList al = new ArrayList(310);
            ...
            if(family >= 0)
            {
                ...
                for(int i=0; i<abbreviations.length; i++)
                {
                       ...
                       && allcaps.startsWith(suffixes[i].toUpperCase()))
                    {
                        ...
                        if(allcaps.length() > suffixes[i].length())
                            allcaps =
                            allcaps.substring(suffixes[i].length());
                        else
                            allcaps = "";
                ...
                if(device.length() > 0)
                {
                    ...
                    if(allcaps.startsWith("-"))
                    {
                        ...
                        {
                            char lastChar =
                            allcaps.charAt(allcaps.length() - 1);
                            ...
                            if(!Character.isDigit(lastChar))
                            {
                                ...
                                {
                                    allcaps =
                                    allcaps.substring(0,(allcaps.length() - 1));
    ...
    {
        return((family >= 0) && (device.length() > 0) && (speed != 0)
               && (pckage.length() > 0));
    }
    ...
    public static void main (String[] args)
    {
        ...
        if(args.length > 0)
        {
            ...
            System.out.println("Family: " + xd.getFamily() + " = " + xd.getFamilyAsString());
            ...
            System.out.println();
            System.out.println("isXilinxDevice: " +
                               xd.isXilinxDevice());
            System.out.println("isFullySpecified: " +
                               xd.isFullySpecified());
            System.out.println();
        }
        else
