...
public class GlobalDebug
{
    ...
    public GlobalDebug(String tag,boolean visible,long levels,OutputStream os)
    {
        ...
        if(tag==null)
            throw new IllegalArgumentException("Must specify tag for debug class!");
     ...
     *
     * @param level a value of type 'long'
     ...
     *
     * @param level level of this output
     * @param v object to .toString() and print
     */
     ...
     *
     * @param v a value of type 'Object'
     */
    ...
    {
        return("** Tag: ["+tag+"] is: "+(visible?"ON":"OFF")+" Levels: 0x"+Long.toHexString(levels)+" **");
    }

    public static void inc() { GlobalDebug.Writer.inc(); }

    public static void dec() { GlobalDebug.Writer.dec(); }

    public static void decAll() { GlobalDebug.Writer.decAll(); }
     ...
     */
    public void pushPreface(String s) { dw.pushPreface(s); }
    
    /**
     * Pop MRU preface off stack
     *
     */
    public void popPreface() { dw.popPreface(); }
    ...
    public final static class Writer extends FilterWriter
    {
         ...
         * @param s a value of type 'String'
         */
        public void pushPreface(String s) { prefaces.addFirst(s); }
    
        /**
         * Pop MRU preface off stack
         *
         */
        public void popPreface() { prefaces.removeFirst(); }
    }    
}
