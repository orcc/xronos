...
public class Shine
{
    ...
    /**
     * Default shine invocation. Given a tag and an object,
     * displays a tree for the object hierarchy. Execution of
     * debugee is paused until this window (and all its created windows)
     * are closed or cleared.
     *
     * @param tag ID Tag for this group of windows
     * @param o root object for the object hierarchy to browse
     */
    ...
    /**
     * Given a tag and an object, displays a treefor the object
     * hierarchy. Does not pause program execution.
     *
     * @param tag ID Tag for this group of windows
     * @param o root object for the object hierarchy to browse
     */
    ...
    /**
     * Given a tag and an object,
     * displays a table broswer for the object hierarchy. Execution of
     * debugee is paused until this window (and all its created windows)
     * are closed or cleared.
     *
     * @param tag ID Tag for this group of windows
    ...
    /**
     * Given a tag and an object,
     * displays a table browser for the object hierarchy. Execution of
     * debugee is NOT paused.
     *
     * @param tag ID Tag for this group of windows
     * @param o root object for the object hierarchy to browse
     */
     ...
     *
     * @param tag ID Tag for this group of windows
     * @param o Root object to examine
     * @param wait do we wait?
     * @param tree tree or table? true if tree
     */
