...
/**
 * A PrintWriter variant which automatically indents each line of
 * output by a dynamically configurable indent String (normally
 * whitespace, such as a tab or space, but it could be any string).
 * 
...
public class IndentWriter extends PrintWriter
{
    ...
    /**
     * Constructs an IndentWriter without, automatic line flushing,
     ...
     *
     * @param base_indent the initial number of indentation strings
     *                    to write at the start of each line
     */
    ...
    /**
     * Sets the indentation string to be written at the start of
     * each line, once for each level of indentation.  The default
     * indent string is a tab.
     */
