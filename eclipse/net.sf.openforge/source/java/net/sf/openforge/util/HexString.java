...
/**
 * HexString has lots of ways to create hex strings out
 * of the basic Java types.
 * <P>
 * 
...
public class HexString
{
     ...
     * @param prefixed whether or not to include the hexadecimal prefic 0x
    ...
    {
        String s = prefix + HEXDIGITS[(data >> 12) & 0xF] + HEXDIGITS[(data >> 8) & 0xF] + HEXDIGITS[(data >> 4) & 0xF] 
                   + HEXDIGITS[data & 0xF];
    ...
    {
        String s = prefix + HEXDIGITS[(data >> 28) & 0xF] + HEXDIGITS[(data >> 24) & 0xF] + HEXDIGITS[(data >> 20) & 0xF] 
                   + HEXDIGITS[(data >> 16) & 0xF] + HEXDIGITS[(data >> 12) & 0xF] + HEXDIGITS[(data >> 8) & 0xF] 
                   + HEXDIGITS[(data >> 4) & 0xF] + HEXDIGITS[data & 0xF];
    ...
    {
        String s = prefix + HEXDIGITS[(int)(data >> 60) & 0xF] + HEXDIGITS[(int)(data >> 56) & 0xF] 
                   + HEXDIGITS[(int)(data >> 52) & 0xF] + HEXDIGITS[(int)(data >> 48) & 0xF] + HEXDIGITS[(int)(data >> 44) & 0xF] 
                   + HEXDIGITS[(int)(data >> 40) & 0xF] + HEXDIGITS[(int)(data >> 36) & 0xF] + HEXDIGITS[(int)(data >> 32) & 0xF] 
                   + HEXDIGITS[(int)(data >> 28) & 0xF] + HEXDIGITS[(int)(data >> 24) & 0xF] + HEXDIGITS[(int)(data >> 20) & 0xF] 
                   + HEXDIGITS[(int)(data >> 16) & 0xF] + HEXDIGITS[(int)(data >> 12) & 0xF] + HEXDIGITS[(int)(data >> 8) & 0xF] 
                   + HEXDIGITS[(int)(data >> 4) & 0xF] + HEXDIGITS[(int)data & 0xF];
     ...
     * 
     * @param data  the array of data bytes
     * @param prefixed whether or not to add the 0x prefix to each byte
     * @return      a hexadecimal representation of the data
     */
    ...
    /**
     * Convert a hex string to an unsigned byte value.
     * The string may have a hexadecimal prefix.
     * 
     ...
     * to a byte array.
     * 
     * @param string the string of hex data
    ...
    public static void main(String[] args)
    {
        ...
        {
            (byte)0x0f, (byte)0x80, (byte)0x00, (byte)0x05, (byte)0x6a, (byte)0x61, (byte)0x76, (byte)0x61, (byte)0x69, 
            (byte)0x6e, (byte)0x67, (byte)0x2e, (byte)0x2e, (byte)0x43, (byte)0x6f, (byte)0x6c, (byte)0x52, (byte)0x65, 
            (byte)0x73, (byte)0x6f, (byte)0x6b, (byte)0x53, (byte)0xf9, (byte)0x9f, (byte)0x02, (byte)0x00, (byte)0x00, 
            (byte)0x78, (byte)0x61, (byte)0x76, (byte)0x61, (byte)0x2e, (byte)0x43, (byte)0x6f, (byte)0x6c, (byte)0x6f, 
            (byte)0x83, (byte)0x10, (byte)0x8f, (byte)0x33, (byte)0x46, (byte)0x00, (byte)0x06, (byte)0x66, (byte)0x61, 
            (byte)0x49, (byte)0x00, (byte)0x05, (byte)0x65, (byte)0x4c, (byte)0x00, (byte)0x02, (byte)0x1b, (byte)0x4c, 
            (byte)0x6a, (byte)0x61, (byte)0x77, (byte)0x74, (byte)0x2f, (byte)0x63, (byte)0x2f, (byte)0x43, (byte)0x6f, 
            (byte)0x6c, (byte)0x61, (byte)0x63, (byte)0x65, (byte)0x3b, (byte)0x72, (byte)0x67, (byte)0x62, (byte)0x76, 
            (byte)0x74, (byte)0x00, (byte)0x02, (byte)0x5b, (byte)0x66, (byte)0x76, (byte)0x61, (byte)0x6c, (byte)0x7e, 
            (byte)0x00, (byte)0x03, (byte)0x4c, (byte)0x65, (byte)0x43, (byte)0x6f, (byte)0x6e, (byte)0x74, (byte)0x00, 
            (byte)0x17, (byte)0x4c, (byte)0x2f, (byte)0x61, (byte)0x77, (byte)0x74, (byte)0x6e, (byte)0x74, (byte)0x43, 
            (byte)0x6f, (byte)0x74, (byte)0x3b, (byte)0x78, (byte)0x70, (byte)0xff, (byte)0x00, (byte)0x00, (byte)0x00
        };
        ...
        String decoded_data_encoded = HexString.toHexString(decoded_data, false);
    ...
    /**
     * Converts the standard primitive wrapper objects
     * to a hex value representation.
     * 
     * @param value the object wrapper
     * @param size the desired bitwidth
    ...
    public static String valueToHex(Object value, int size)
    {
        ...
        {
            constant_hex = shortToHex((short)(((Character)value).charValue()), size);
        }
    ...
    /**
     * Converts the standard primitive wrapper objects
     * to a hex value representation using the minimum
     * bitwidth needed to represent the value.
     * 
     * @param value the object wrapper
     * @return the hex representation
     */
    ...
    /**
     * Converts the standard primitive wrapper objects
     * to a long value representation.
     * 
     * @param value the object wrapper
     * @param size the desired bitwidth
    ...
    /**
     * Inverts, and then converts the standard primitive wrapper objects
     * to a hex value representation.
     * 
     * @param value the object wrapper
     * @param size the desired bitwidth
    ...
    public static String invertValueToHex(Object value, int size)
    {
        ...
        {
            constant_hex = shortToHex((short)~((Short)value).shortValue(), size);
        }
        else if (value instanceof Byte)
        {
        ...
        {
            constant_hex = charToHex((short)~(Character.getNumericValue(((Character)value).charValue())), size);
        }
        else if (value instanceof Boolean)
        {
            if (((Boolean)value).booleanValue())
    ...
    /**
     * Converts an integer value to an exactly sized
     * hex representation.
     * 
    ...
    /**
     * Converts a short value to an exactly sized
     * hex representation.
     * 
    ...
    /**
     * Converts a character value to an exactly sized
     * hex representation.
     * 
     * @param value the character value, as a short
     * @param size the desired bitwidth
     * @return the hex representation
     */
    ...
    /**
     * Converts a byte value to an exactly sized
     * hex representation.
     * 
    ...
    /**
     * Converts a long value to an exactly sized
     * hex representation.
     * 
     * @param value the i]long value
     * @param size the desired bitwidth
     * @return the hex representation
     */
