...
public class OptionMultiFile extends OptionFile
{
	...
	public boolean isValid(String s)
	{
		...
		{
			if (!super.isValid((String)it.next())) return false;
		}
		return true;
	}
	...
	/**
	 * @see net.sf.openforge.app.project.Option#printXML(net.sf.openforge.util.IndentWriter, java.lang.String)
	 */
