...
/** 
 * An option which allows a string to be used for the value, picked
...
public class OptionPickOne extends OptionString
{
    ...
    public OptionPickOne(OptionKey key,
    ...
    /**
     * This method checks to see if the value passed to the option is 
     * of the right type. If true, it replaces the option value with that 
     * new value. Otherwise, it throws and InvalidOptionValue Exception.
     * @param slabel SearchLabel that can be used to get the scope.
     * @param val value to the option.
     */
     ...
     * @param slabel SearchLabel to find the scope 
    ...
    /**
     * Will the option accept values which are not on the
     * pre-defined list?
     *
